...
FIELDS = {
    ...
    'CDM_2': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'CHARGE_CODE_ALIAS', 'HL79999', -1),
    ...
    'CDM_6': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'EXPLODING_CHARGES', 'HL79999', -1),
    ...
    'CM2_2': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'SCHEDULED_TIME_POINT', 'HL79999', -1),
    'CM2_3': ('leaf', None, 'ST', 'DESCRIPTION_OF_TIME_POINT', None, -1),
    'CM2_4': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'EVENTS_SCHEDULED_THIS_TIME_POINT', 'HL79999', -1),
    ...
    'GP2_11': ('sequence', DATATYPES_STRUCTS['CP'], 'CP', 'EXPECTED_HCFA_PAYMENT_AMOUNT', None, -1),
    ...
    'MFA_5': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'PRIMARY_KEY_VALUE_MFA', 'HL79999', -1),
    ...
    'OBX_12': ('sequence', DATATYPES_STRUCTS['TS'], 'TS', 'DATE_LAST_OBSERVATION_NORMAL_VALUE', None, -1),
    ...
    'OM1_7': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'OTHER_SERVICE_TEST_OBSERVATION_IDS_FOR_THE_OBSERVATION', 'HL79999', -1),
    ...
    'OM1_13': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'IDENTITY_OF_INSTRUMENT_USED_TO_PERFORM_THIS_STUDY', 'HL79999', -1),
    ...
    'OM1_27': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'OUTSIDE_SITE_S_WHERE_OBSERVATION_MAY_BE_PERFORMED', 'HL79999', -1),
    ...
    'OM1_31': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'OBSERVATIONS_REQUIRED_TO_INTERPRET_THE_OBSERVATION', 'HL79999', -1),
    ...
    'OM1_39': ('leaf', None, 'TX', 'FACTORS_THAT_MAY_AFFECT_AFFECT_THE_OBSERVATION', None, -1),
    ...
    'OM2_6': ('sequence', DATATYPES_STRUCTS['RFR'], 'RFR', 'REFERENCE_NORMAL_RANGE_ORDINAL_AND_CONTINUOUS_OBSERVATIONS', None, -1),
    'OM2_7': ('sequence', DATATYPES_STRUCTS['NR'], 'NR', 'CRITICAL_RANGE_FOR_ORDINAL_AND_CONTINUOUS_OBSERVATIONS', None, -1),
    ...
    'OM3_4': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'NORMAL_TEXT_CODES_FOR_CATEGORICAL_OBSERVATIONS', 'HL79999', -1),
    'OM3_5': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'ABNORMAL_TEXT_CODES_FOR_CATEGORICAL_OBSERVATIONS', 'HL79999', -1),
    'OM3_6': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'CRITICAL_TEXT_CODES_FOR_CATEGORICAL_OBSERVATIONS', 'HL79999', -1),
    ...
    'OM5_2': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'TEST_OBSERVATIONS_INCLUDED_WITHIN_AN_ORDERED_TEST_BATTERY', 'HL79999', -1),
    ...
    'ORG_3': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'ORGANIZATION_UNIT_TYPE_CODE_ORG', 'HL70474', -1),
    ...
    'ORG_8': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'HEALTH_CARE_PROVIDER_AREA_OF_SPECIALIZATION_CODE', 'HL70454', -1),
    ...
    'PRA_11': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'GOVERNMENT_REIMBURSEMENT_BILLING_ELIGIBILITY', 'HL70401', -1),
    ...
    'ROL_10': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'ORGANIZATION_UNIT_TYPE_ROL', 'HL70406', -1),
    'ROL_11': ('sequence', DATATYPES_STRUCTS['XAD'], 'XAD', 'OFFICE_HOME_ADDRESS', None, -1),
    ...
    'RXR_2': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'ADMINISTRATION_SITE', 'HL70163', -1),
    ...
    'SAC_6': ('sequence', DATATYPES_STRUCTS['SPS'], 'SPS', 'SPECIMEN_SOURCE', 'HL70070', -1),
    ...
    'SAC_43': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'SPECIAL_HANDLING_CONSIDERATIONS', 'HL70376', -1),
    ...
    'TCC_3': ('sequence', DATATYPES_STRUCTS['SPS'], 'SPS', 'SPECIMEN_SOURCE', 'HL70070', -1),
