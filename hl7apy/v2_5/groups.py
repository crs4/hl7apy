...
GROUPS = {
  ...
  'ORU_W01_ORDER_OBSERVATION': (
      ...
      (
          ...
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['CTD', SEGMENTS['CTD'], (0, 1), 'SEG'],
          ['ORU_W01_OBSERVATION', None, (1, -1), 'GRP'],
          ['FT1', SEGMENTS['FT1'], (0, -1), 'SEG'],
          ['CTI', SEGMENTS['CTI'], (0, -1), 'SEG'],
  ...
  'RPA_I09_PROCEDURE': (
      ...
      (
          ['PR1', SEGMENTS['PR1'], (1, 1), 'SEG'],
          ['RPA_I09_AUTHORIZATION', None, (0, 1), 'GRP'],
      ),
   ),
  'RPA_I09_AUTHORIZATION': (
      'sequence',
  ...
  'RPA_I10_PROCEDURE': (
      ...
      (
          ['PR1', SEGMENTS['PR1'], (1, 1), 'SEG'],
          ['RPA_I10_AUTHORIZATION', None, (0, 1), 'GRP'],
      ),
   ),
  'RPA_I10_AUTHORIZATION': (
      'sequence',
  ...
  'RPA_I11_PROCEDURE': (
      ...
      (
          ['PR1', SEGMENTS['PR1'], (1, 1), 'SEG'],
          ['RPA_I11_AUTHORIZATION', None, (0, 1), 'GRP'],
      ),
   ),
  'RPA_I11_AUTHORIZATION': (
      'sequence',
  ...
  'RSP_Z82_ENCODED_ORDER': (
      ...
      (
          ['RXE', SEGMENTS['RXE'], (1, 1), 'SEG'],
          ['RSP_Z82_TIMING_ENCODED', None, (1, 1), 'GRP'],
          ['RXR', SEGMENTS['RXR'], (1, -1), 'SEG'],
          ['RXC', SEGMENTS['RXC'], (0, -1), 'SEG'],
      ),
   ),
