...
GROUPS = {
  ...
  'CCI_I22_RESOURCE_DETAIL': (
      'sequence',
      (
          ['CCI_I22_RESOURCE_OBJECT', None, (0, 1), 'GRP'],
          ['OBX', SEGMENTS['OBX'], (0, -1), 'SEG'],
      ),
   ),
  'CCI_I22_RESOURCE_OBJECT': (
      'sequence',
      (
          ['AIS', SEGMENTS['AIS'], (0, 1), 'SEG'],
          ['AIG', SEGMENTS['AIG'], (0, 1), 'SEG'],
          ['AIL', SEGMENTS['AIL'], (0, 1), 'SEG'],
          ['AIP', SEGMENTS['AIP'], (0, 1), 'SEG'],
      ),
   ),
  ...
  'CCI_I22_CLINICAL_HISTORY_DETAIL': (
      'sequence',
      (
          ['CCI_I22_CLINICAL_HISTORY_OBJECT', None, (0, 1), 'GRP'],
          ['OBX', SEGMENTS['OBX'], (0, -1), 'SEG'],
      ),
   ),
  ...
  'CCI_I22_ROLE_CLINICAL_HISTORY': (
      'sequence',
      (
          ['CCI_I22_ROLE_CLINICAL_HISTORY_OBJECT', None, (0, 1), 'GRP'],
  ...
  'CCI_I22_ROLE_PROBLEM': (
      'sequence',
      (
          ['CCI_I22_ROLE_PROBLEM_OBJECT', None, (0, 1), 'GRP'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
      ),
   ),
  ...
  'CCI_I22_ROLE_GOAL': (
      'sequence',
      (
          ['CCI_I22_ROAL_GOAL_OBJECT', None, (0, 1), 'GRP'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
      ),
   ),
  'CCI_I22_ROAL_GOAL_OBJECT': (
      'sequence',
      (
          ['ROL', SEGMENTS['ROL'], (0, 1), 'SEG'],
          ['PRD', SEGMENTS['PRD'], (0, 1), 'SEG'],
  ...
  'CCI_I22_ROLE_PATHWAY': (
      'sequence',
      (
          ['CCI_I22_ROLE_PATHWAY_OBJECT', None, (0, 1), 'GRP'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
      ),
   ),
  ...
  'CCR_I16_PROBLEM': (
      ...
      (
          ...
          ['CCR_I16_PROBLEM_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  ...
  'CCR_I17_CLINICAL_ORDER': (
      ...
      (
          ['ORC', SEGMENTS['ORC'], (1, 1), 'SEG'],
          ['CCR_I17_CLINICAL_ORDER_TIMING', None, (0, -1), 'GRP'],
          ['CCR_I17_CLINICAL_ORDER_DETAIL', None, (1, -1), 'GRP'],
          ['CTI', SEGMENTS['CTI'], (0, -1), 'SEG'],
      ),
   ),
  'CCR_I17_CLINICAL_ORDER_TIMING': (
      'sequence',
      (
          ['TQ1', SEGMENTS['TQ1'], (1, 1), 'SEG'],
          ['TQ2', SEGMENTS['TQ2'], (0, -1), 'SEG'],
  ...
  'CCR_I17_CLINICAL_ORDER_DETAIL': (
      'sequence',
      (
          ['CCR_I17_CLINICAL_ORDER_OBJECT', None, (1, 1), 'GRP'],
          ['CCR_I17_CLINICAL_ORDER_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'CCR_I17_CLINICAL_ORDER_OBJECT': (
      'sequence',
      (
          ['OBR', SEGMENTS['OBR'], (0, 1), 'SEG'],
          ['RXO', SEGMENTS['RXO'], (0, 1), 'SEG'],
  ...
  'CCR_I17_CLINICAL_ORDER_OBSERVATION': (
      'sequence',
      (
          ['OBX', SEGMENTS['OBX'], (1, 1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
  ...
  'CCR_I17_APPOINTMENT_HISTORY': (
      ...
      (
          ['SCH', SEGMENTS['SCH'], (1, 1), 'SEG'],
          ['CCR_I17_RESOURCES', None, (0, -1), 'GRP'],
      ),
   ),
  'CCR_I17_RESOURCES': (
      'sequence',
      (
          ['RGS', SEGMENTS['RGS'], (1, 1), 'SEG'],
          ['CCR_I17_RESOURCE_DETAIL', None, (0, -1), 'GRP'],
      ),
   ),
  'CCR_I17_RESOURCE_DETAIL': (
      'sequence',
      (
          ['CCR_I17_RESOURCE_OBJECT', None, (1, 1), 'GRP'],
          ['CCR_I17_RESOURCE_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'CCR_I17_RESOURCE_OBJECT': (
      'sequence',
      (
          ['AIS', SEGMENTS['AIS'], (0, 1), 'SEG'],
          ['AIG', SEGMENTS['AIG'], (0, 1), 'SEG'],
  ...
  'CCR_I17_CLINICAL_HISTORY': (
      ...
      (
          ['ORC', SEGMENTS['ORC'], (1, 1), 'SEG'],
          ['CCR_I17_CLINICAL_HISTORY_DETAIL', None, (0, -1), 'GRP'],
          ['CCR_I17_ROLE_CLINICAL_HISTORY', None, (0, -1), 'GRP'],
          ['CTI', SEGMENTS['CTI'], (0, -1), 'SEG'],
      ),
   ),
  'CCR_I17_CLINICAL_HISTORY_DETAIL': (
      'sequence',
      (
          ['CCR_I17_CLINICAL_HISTORY_OBJECT', None, (1, 1), 'GRP'],
          ['CCR_I17_CLINICAL_HISTORY_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'CCR_I17_CLINICAL_HISTORY_OBJECT': (
      'sequence',
      (
          ['OBR', SEGMENTS['OBR'], (0, 1), 'SEG'],
          ['ODS', SEGMENTS['ODS'], (0, 1), 'SEG'],
  ...
  'CCR_I17_CLINICAL_HISTORY_OBSERVATION': (
      'sequence',
      (
          ['OBX', SEGMENTS['OBX'], (0, -1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
  ...
  'CCR_I17_ROLE_CLINICAL_HISTORY': (
      'sequence',
      (
          ['CCR_I17_ROLE_CLINICAL_HISTORY_OBJECT', None, (1, 1), 'GRP'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
      ),
   ),
  'CCR_I17_ROLE_CLINICAL_HISTORY_OBJECT': (
      'sequence',
      (
          ['ROL', SEGMENTS['ROL'], (0, 1), 'SEG'],
          ['PRD', SEGMENTS['PRD'], (0, 1), 'SEG'],
  ...
  'CCR_I17_MEDICATION_HISTORY': (
      ...
      (
          ['ORC', SEGMENTS['ORC'], (1, 1), 'SEG'],
          ['CCR_I17_MEDICATION_ORDER_DETAIL', None, (0, 1), 'GRP'],
          ['CCR_I17_MEDICATION_ENCODING_DETAIL', None, (0, 1), 'GRP'],
          ['CCR_I17_MEDICATION_ADMINISTRATION_DETAIL', None, (0, -1), 'GRP'],
          ['CTI', SEGMENTS['CTI'], (0, -1), 'SEG'],
      ),
   ),
  'CCR_I17_MEDICATION_ORDER_DETAIL': (
      'sequence',
      (
          ['RXO', SEGMENTS['RXO'], (1, 1), 'SEG'],
          ['RXR', SEGMENTS['RXR'], (1, -1), 'SEG'],
          ['RXC', SEGMENTS['RXC'], (0, -1), 'SEG'],
          ['CCR_I17_MEDICATION_ORDER_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'CCR_I17_MEDICATION_ORDER_OBSERVATION': (
      'sequence',
      (
          ['OBX', SEGMENTS['OBX'], (0, -1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
  ...
  'CCR_I17_MEDICATION_ENCODING_DETAIL': (
      'sequence',
      (
          ['RXE', SEGMENTS['RXE'], (1, 1), 'SEG'],
          ['RXR', SEGMENTS['RXR'], (1, -1), 'SEG'],
          ['RXC', SEGMENTS['RXC'], (0, -1), 'SEG'],
          ['CCR_I17_MEDICATION_ENCODING_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'CCR_I17_MEDICATION_ENCODING_OBSERVATION': (
      'sequence',
      (
          ['OBX', SEGMENTS['OBX'], (0, -1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
  ...
  'CCR_I17_MEDICATION_ADMINISTRATION_DETAIL': (
      'sequence',
      (
          ['RXA', SEGMENTS['RXA'], (1, -1), 'SEG'],
          ['RXR', SEGMENTS['RXR'], (1, 1), 'SEG'],
          ['CCR_I17_MEDICATION_ADMINISTRATION_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'CCR_I17_MEDICATION_ADMINISTRATION_OBSERVATION': (
      'sequence',
      (
          ['OBX', SEGMENTS['OBX'], (0, -1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
  ...
  'CCR_I17_PROBLEM': (
      ...
      (
          ['PRB', SEGMENTS['PRB'], (1, 1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['CCR_I17_ROLE_PROBLEM', None, (0, -1), 'GRP'],
          ['CCR_I17_PROBLEM_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'CCR_I17_ROLE_PROBLEM': (
      'sequence',
      (
          ['CCR_I17_ROLE_PROBLEM_OBJECT', None, (1, 1), 'GRP'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
      ),
   ),
  'CCR_I17_ROLE_PROBLEM_OBJECT': (
      'sequence',
      (
          ['ROL', SEGMENTS['ROL'], (0, 1), 'SEG'],
          ['PRD', SEGMENTS['PRD'], (0, 1), 'SEG'],
  ...
  'CCR_I17_GOAL': (
      ...
      (
          ['GOL', SEGMENTS['GOL'], (1, 1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['CCR_I17_ROLE_GOAL', None, (0, -1), 'GRP'],
          ['CCR_I17_GOAL_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'CCR_I17_ROLE_GOAL': (
      'sequence',
      (
          ['CCR_I17_ROLE_GOAL_OBJECT', None, (1, 1), 'GRP'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
      ),
   ),
  'CCR_I17_ROLE_GOAL_OBJECT': (
      'sequence',
      (
          ['ROL', SEGMENTS['ROL'], (0, 1), 'SEG'],
          ['PRD', SEGMENTS['PRD'], (0, 1), 'SEG'],
  ...
  'CCR_I17_PATHWAY': (
      ...
      (
          ['PTH', SEGMENTS['PTH'], (1, 1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['CCR_I17_ROLE_PATHWAY', None, (0, -1), 'GRP'],
          ['CCR_I17_PATHWAY_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'CCR_I17_ROLE_PATHWAY': (
      'sequence',
      (
          ['CCR_I17_ROLE_PATHWAY_OBJECT', None, (1, 1), 'GRP'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
      ),
   ),
  'CCR_I17_ROLE_PATHWAY_OBJECT': (
      'sequence',
      (
          ['ROL', SEGMENTS['ROL'], (0, 1), 'SEG'],
          ['PRD', SEGMENTS['PRD'], (0, 1), 'SEG'],
  ...
  'CCR_I18_CLINICAL_ORDER': (
      ...
      (
          ['ORC', SEGMENTS['ORC'], (1, 1), 'SEG'],
          ['CCR_I18_CLINICAL_ORDER_TIMING', None, (0, -1), 'GRP'],
          ['CCR_I18_CLINICAL_ORDER_DETAIL', None, (1, -1), 'GRP'],
          ['CTI', SEGMENTS['CTI'], (0, -1), 'SEG'],
      ),
   ),
  'CCR_I18_CLINICAL_ORDER_TIMING': (
      'sequence',
      (
          ['TQ1', SEGMENTS['TQ1'], (1, 1), 'SEG'],
          ['TQ2', SEGMENTS['TQ2'], (0, -1), 'SEG'],
  ...
  'CCR_I18_CLINICAL_ORDER_DETAIL': (
      'sequence',
      (
          ['CCR_I18_CLINICAL_ORDER_OBJECT', None, (1, 1), 'GRP'],
          ['CCR_I18_CLINICAL_ORDER_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'CCR_I18_CLINICAL_ORDER_OBJECT': (
      'sequence',
      (
          ['OBR', SEGMENTS['OBR'], (0, 1), 'SEG'],
          ['RXO', SEGMENTS['RXO'], (0, 1), 'SEG'],
  ...
  'CCR_I18_CLINICAL_ORDER_OBSERVATION': (
      'sequence',
      (
          ['OBX', SEGMENTS['OBX'], (1, 1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
  ...
  'CCR_I18_APPOINTMENT_HISTORY': (
      ...
      (
          ['SCH', SEGMENTS['SCH'], (1, 1), 'SEG'],
          ['CCR_I18_RESOURCES', None, (0, -1), 'GRP'],
      ),
   ),
  'CCR_I18_RESOURCES': (
      'sequence',
      (
          ['RGS', SEGMENTS['RGS'], (1, 1), 'SEG'],
          ['CCR_I18_RESOURCE_DETAIL', None, (0, -1), 'GRP'],
      ),
   ),
  'CCR_I18_RESOURCE_DETAIL': (
      'sequence',
      (
          ['CCR_I18_RESOURCE_OBJECT', None, (1, 1), 'GRP'],
          ['CCR_I18_RESOURCE_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'CCR_I18_RESOURCE_OBJECT': (
      'sequence',
      (
          ['AIS', SEGMENTS['AIS'], (0, 1), 'SEG'],
          ['AIG', SEGMENTS['AIG'], (0, 1), 'SEG'],
  ...
  'CCR_I18_CLINICAL_HISTORY': (
      ...
      (
          ['ORC', SEGMENTS['ORC'], (1, 1), 'SEG'],
          ['CCR_I18_CLINICAL_HISTORY_DETAIL', None, (0, -1), 'GRP'],
          ['CCR_I18_ROLE_CLINICAL_HISTORY', None, (0, -1), 'GRP'],
          ['CTI', SEGMENTS['CTI'], (0, -1), 'SEG'],
      ),
   ),
  'CCR_I18_CLINICAL_HISTORY_DETAIL': (
      'sequence',
      (
          ['CCR_I18_CLINICAL_HISTORY_OBJECT', None, (1, 1), 'GRP'],
          ['CCR_I18_CLINICAL_HISTORY_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'CCR_I18_CLINICAL_HISTORY_OBJECT': (
      'sequence',
      (
          ['OBR', SEGMENTS['OBR'], (0, 1), 'SEG'],
          ['ODS', SEGMENTS['ODS'], (0, 1), 'SEG'],
  ...
  'CCR_I18_CLINICAL_HISTORY_OBSERVATION': (
      'sequence',
      (
          ['OBX', SEGMENTS['OBX'], (0, -1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
  ...
  'CCR_I18_ROLE_CLINICAL_HISTORY': (
      'sequence',
      (
          ['CCR_I18_ROLE_CLINICAL_HISTORY_OBJECT', None, (1, 1), 'GRP'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
      ),
   ),
  'CCR_I18_ROLE_CLINICAL_HISTORY_OBJECT': (
      'sequence',
      (
          ['ROL', SEGMENTS['ROL'], (0, 1), 'SEG'],
          ['PRD', SEGMENTS['PRD'], (0, 1), 'SEG'],
  ...
  'CCR_I18_MEDICATION_HISTORY': (
      ...
      (
          ['ORC', SEGMENTS['ORC'], (1, 1), 'SEG'],
          ['CCR_I18_MEDICATION_ORDER_DETAIL', None, (0, 1), 'GRP'],
          ['CCR_I18_MEDICATION_ENCODING_DETAIL', None, (0, 1), 'GRP'],
          ['CCR_I18_MEDICATION_ADMINISTRATION_DETAIL', None, (0, -1), 'GRP'],
          ['CTI', SEGMENTS['CTI'], (0, -1), 'SEG'],
      ),
   ),
  'CCR_I18_MEDICATION_ORDER_DETAIL': (
      'sequence',
      (
          ['RXO', SEGMENTS['RXO'], (1, 1), 'SEG'],
          ['RXR', SEGMENTS['RXR'], (1, -1), 'SEG'],
          ['RXC', SEGMENTS['RXC'], (0, -1), 'SEG'],
          ['CCR_I18_MEDICATION_ORDER_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'CCR_I18_MEDICATION_ORDER_OBSERVATION': (
      'sequence',
      (
          ['OBX', SEGMENTS['OBX'], (0, -1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
  ...
  'CCR_I18_MEDICATION_ENCODING_DETAIL': (
      'sequence',
      (
          ['RXE', SEGMENTS['RXE'], (1, 1), 'SEG'],
          ['RXR', SEGMENTS['RXR'], (1, -1), 'SEG'],
          ['RXC', SEGMENTS['RXC'], (0, -1), 'SEG'],
          ['CCR_I18_MEDICATION_ENCODING_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'CCR_I18_MEDICATION_ENCODING_OBSERVATION': (
      'sequence',
      (
          ['OBX', SEGMENTS['OBX'], (0, -1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
  ...
  'CCR_I18_MEDICATION_ADMINISTRATION_DETAIL': (
      'sequence',
      (
          ['RXA', SEGMENTS['RXA'], (1, -1), 'SEG'],
          ['RXR', SEGMENTS['RXR'], (1, 1), 'SEG'],
          ['CCR_I18_MEDICATION_ADMINISTRATION_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'CCR_I18_MEDICATION_ADMINISTRATION_OBSERVATION': (
      'sequence',
      (
          ['OBX', SEGMENTS['OBX'], (0, -1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
  ...
  'CCR_I18_PROBLEM': (
      ...
      (
          ['PRB', SEGMENTS['PRB'], (1, 1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['CCR_I18_ROLE_PROBLEM', None, (0, -1), 'GRP'],
          ['CCR_I18_PROBLEM_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'CCR_I18_ROLE_PROBLEM': (
      'sequence',
      (
          ['CCR_I18_ROLE_PROBLEM_OBJECT', None, (1, 1), 'GRP'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
      ),
   ),
  'CCR_I18_ROLE_PROBLEM_OBJECT': (
      'sequence',
      (
          ['ROL', SEGMENTS['ROL'], (0, 1), 'SEG'],
          ['PRD', SEGMENTS['PRD'], (0, 1), 'SEG'],
  ...
  'CCR_I18_GOAL': (
      ...
      (
          ['GOL', SEGMENTS['GOL'], (1, 1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['CCR_I18_ROLE_GOAL', None, (0, -1), 'GRP'],
          ['CCR_I18_GOAL_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'CCR_I18_ROLE_GOAL': (
      'sequence',
      (
          ['CCR_I18_ROLE_GOAL_OBJECT', None, (1, 1), 'GRP'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
      ),
   ),
  'CCR_I18_ROLE_GOAL_OBJECT': (
      'sequence',
      (
          ['ROL', SEGMENTS['ROL'], (0, 1), 'SEG'],
          ['PRD', SEGMENTS['PRD'], (0, 1), 'SEG'],
  ...
  'CCR_I18_PATHWAY': (
      ...
      (
          ['PTH', SEGMENTS['PTH'], (1, 1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['CCR_I18_ROLE_PATHWAY', None, (0, -1), 'GRP'],
          ['CCR_I18_PATHWAY_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'CCR_I18_ROLE_PATHWAY': (
      'sequence',
      (
          ['CCR_I18_ROLE_PATHWAY_OBJECT', None, (1, 1), 'GRP'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
      ),
   ),
  'CCR_I18_ROLE_PATHWAY_OBJECT': (
      'sequence',
      (
          ['ROL', SEGMENTS['ROL'], (0, 1), 'SEG'],
          ['PRD', SEGMENTS['PRD'], (0, 1), 'SEG'],
  ...
  'CQU_I19_CLINICAL_HISTORY_DETAIL': (
      'sequence',
      (
          ['CQU_I19_CLINICAL_HISTORY_OBJECT', None, (0, 1), 'GRP'],
  ...
  'CQU_I19_ROLE_CLINICAL_HISTORY': (
      'sequence',
      (
          ['CQU_I19_ROLE_CLINICAL_HISTORY_OBJECT', None, (0, 1), 'GRP'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
      ),
   ),
  ...
  'CRM_C02_PATIENT': (
      ...
      (
          ...
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
          ['ARV', SEGMENTS['ARV'], (0, -1), 'SEG'],
          ['CRM_C02_PATIENT_VISIT', None, (0, 1), 'GRP'],
          ['CSR', SEGMENTS['CSR'], (1, 1), 'SEG'],
          ['CSP', SEGMENTS['CSP'], (0, -1), 'SEG'],
      ),
   ),
  'CRM_C02_PATIENT_VISIT': (
      'sequence',
      (
          ['PV1', SEGMENTS['PV1'], (1, 1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
  ...
  'CRM_C03_PATIENT': (
      ...
      (
          ...
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
          ['ARV', SEGMENTS['ARV'], (0, -1), 'SEG'],
          ['CRM_C03_PATIENT_VISIT', None, (0, 1), 'GRP'],
          ['CSR', SEGMENTS['CSR'], (1, 1), 'SEG'],
          ['CSP', SEGMENTS['CSP'], (0, -1), 'SEG'],
      ),
   ),
  'CRM_C03_PATIENT_VISIT': (
      'sequence',
      (
          ['PV1', SEGMENTS['PV1'], (1, 1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
  ...
  'CRM_C04_PATIENT': (
      ...
      (
          ...
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
          ['ARV', SEGMENTS['ARV'], (0, -1), 'SEG'],
          ['CRM_C04_PATIENT_VISIT', None, (0, 1), 'GRP'],
          ['CSR', SEGMENTS['CSR'], (1, 1), 'SEG'],
          ['CSP', SEGMENTS['CSP'], (0, -1), 'SEG'],
      ),
   ),
  'CRM_C04_PATIENT_VISIT': (
      'sequence',
      (
          ['PV1', SEGMENTS['PV1'], (1, 1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
  ...
  'CRM_C05_PATIENT': (
      ...
      (
          ['PID', SEGMENTS['PID'], (1, 1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
          ['CRM_C05_PATIENT_VISIT', None, (0, 1), 'GRP'],
          ['CSR', SEGMENTS['CSR'], (1, 1), 'SEG'],
          ['CSP', SEGMENTS['CSP'], (0, -1), 'SEG'],
      ),
   ),
  'CRM_C05_PATIENT_VISIT': (
      'sequence',
      (
          ['PV1', SEGMENTS['PV1'], (1, 1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
  ...
  'CRM_C06_PATIENT': (
      ...
      (
          ...
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
          ['ARV', SEGMENTS['ARV'], (0, -1), 'SEG'],
          ['CRM_C06_PATIENT_VISIT', None, (0, 1), 'GRP'],
          ['CSR', SEGMENTS['CSR'], (1, 1), 'SEG'],
          ['CSP', SEGMENTS['CSP'], (0, -1), 'SEG'],
      ),
   ),
  'CRM_C06_PATIENT_VISIT': (
      'sequence',
      (
          ['PV1', SEGMENTS['PV1'], (1, 1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
  ...
  'CRM_C07_PATIENT': (
      ...
      (
          ...
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
          ['ARV', SEGMENTS['ARV'], (0, -1), 'SEG'],
          ['CRM_C07_PATIENT_VISIT', None, (0, 1), 'GRP'],
          ['CSR', SEGMENTS['CSR'], (1, 1), 'SEG'],
          ['CSP', SEGMENTS['CSP'], (0, -1), 'SEG'],
      ),
   ),
  'CRM_C07_PATIENT_VISIT': (
      'sequence',
      (
          ['PV1', SEGMENTS['PV1'], (1, 1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
  ...
  'CRM_C08_PATIENT': (
      ...
      (
          ...
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
          ['ARV', SEGMENTS['ARV'], (0, -1), 'SEG'],
          ['CRM_C08_PATIENT_VISIT', None, (0, 1), 'GRP'],
          ['CSR', SEGMENTS['CSR'], (1, 1), 'SEG'],
          ['CSP', SEGMENTS['CSP'], (0, -1), 'SEG'],
      ),
   ),
  'CRM_C08_PATIENT_VISIT': (
      'sequence',
      (
          ['PV1', SEGMENTS['PV1'], (1, 1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
  ...
  'CSU_C10_PATIENT': (
      ...
      (
          ...
          ['ARV', SEGMENTS['ARV'], (0, -1), 'SEG'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['CSU_C10_VISIT', None, (0, 1), 'GRP'],
          ['CSR', SEGMENTS['CSR'], (1, 1), 'SEG'],
          ['CSU_C10_STUDY_PHASE', None, (1, -1), 'GRP'],
      ),
   ),
  'CSU_C10_VISIT': (
      'sequence',
  ...
  'CSU_C10_STUDY_PHASE': (
      ...
      (
          ['CSP', SEGMENTS['CSP'], (0, 1), 'SEG'],
          ['CSU_C10_STUDY_SCHEDULE', None, (1, -1), 'GRP'],
      ),
   ),
  'CSU_C10_STUDY_SCHEDULE': (
      'sequence',
      (
          ['CSS', SEGMENTS['CSS'], (0, 1), 'SEG'],
          ['CSU_C10_STUDY_OBSERVATION', None, (1, -1), 'GRP'],
          ['CSU_C10_STUDY_PHARM', None, (1, -1), 'GRP'],
      ),
   ),
  'CSU_C10_STUDY_OBSERVATION': (
      'sequence',
      (
          ['CSU_C10_COMMON_ORDER', None, (0, 1), 'GRP'],
          ['OBR', SEGMENTS['OBR'], (1, 1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
          ['CSU_C10_TIMING_QTY', None, (0, -1), 'GRP'],
          ['OBX', SEGMENTS['OBX'], (1, 1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
      ),
   ),
  'CSU_C10_COMMON_ORDER': (
      'sequence',
      (
          ['ORC', SEGMENTS['ORC'], (0, 1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
  ...
  'CSU_C11_PATIENT': (
      ...
      (
          ...
          ['ARV', SEGMENTS['ARV'], (0, -1), 'SEG'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['CSU_C11_VISIT', None, (0, 1), 'GRP'],
          ['CSR', SEGMENTS['CSR'], (1, 1), 'SEG'],
          ['CSU_C11_STUDY_PHASE', None, (1, -1), 'GRP'],
      ),
   ),
  'CSU_C11_VISIT': (
      'sequence',
  ...
  'CSU_C11_STUDY_PHASE': (
      ...
      (
          ['CSP', SEGMENTS['CSP'], (0, 1), 'SEG'],
          ['CSU_C11_STUDY_SCHEDULE', None, (1, -1), 'GRP'],
      ),
   ),
  'CSU_C11_STUDY_SCHEDULE': (
      'sequence',
      (
          ['CSS', SEGMENTS['CSS'], (0, 1), 'SEG'],
          ['CSU_C11_STUDY_OBSERVATION', None, (1, -1), 'GRP'],
          ['CSU_C11_STUDY_PHARM', None, (1, -1), 'GRP'],
      ),
   ),
  'CSU_C11_STUDY_OBSERVATION': (
      'sequence',
      (
          ['CSU_C11_COMMON_ORDER', None, (0, 1), 'GRP'],
          ['OBR', SEGMENTS['OBR'], (1, 1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
          ['CSU_C11_TIMING_QTY', None, (0, -1), 'GRP'],
          ['OBX', SEGMENTS['OBX'], (1, 1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
      ),
   ),
  'CSU_C11_COMMON_ORDER': (
      'sequence',
      (
          ['ORC', SEGMENTS['ORC'], (0, 1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
  ...
  'CSU_C12_PATIENT': (
      ...
      (
          ...
          ['ARV', SEGMENTS['ARV'], (0, -1), 'SEG'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['CSU_C12_VISIT', None, (0, 1), 'GRP'],
          ['CSR', SEGMENTS['CSR'], (1, 1), 'SEG'],
          ['CSU_C12_STUDY_PHASE', None, (1, -1), 'GRP'],
      ),
   ),
  'CSU_C12_VISIT': (
      'sequence',
  ...
  'CSU_C12_STUDY_PHASE': (
      ...
      (
          ['CSP', SEGMENTS['CSP'], (0, 1), 'SEG'],
          ['CSU_C12_STUDY_SCHEDULE', None, (1, -1), 'GRP'],
      ),
   ),
  'CSU_C12_STUDY_SCHEDULE': (
      'sequence',
      (
          ['CSS', SEGMENTS['CSS'], (0, 1), 'SEG'],
          ['CSU_C12_STUDY_OBSERVATION', None, (1, -1), 'GRP'],
          ['CSU_C12_STUDY_PHARM', None, (1, -1), 'GRP'],
      ),
   ),
  'CSU_C12_STUDY_OBSERVATION': (
      'sequence',
      (
          ['CSU_C12_COMMON_ORDER', None, (0, 1), 'GRP'],
          ['OBR', SEGMENTS['OBR'], (1, 1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
          ['CSU_C12_TIMING_QTY', None, (0, -1), 'GRP'],
          ['OBX', SEGMENTS['OBX'], (1, 1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
      ),
   ),
  'CSU_C12_COMMON_ORDER': (
      'sequence',
      (
          ['ORC', SEGMENTS['ORC'], (0, 1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
  ...
  'OMQ_O42_SPECIMEN': (
      ...
      (
          ['SPM', SEGMENTS['SPM'], (1, 1), 'SEG'],
          ['OMQ_O42_SPECIMEN_OBSERVATION', None, (0, -1), 'GRP'],
          ['OMQ_O42_CONTAINER', None, (0, -1), 'GRP'],
      ),
   ),
  'OMQ_O42_SPECIMEN_OBSERVATION': (
      'sequence',
      (
          ['OBX', SEGMENTS['OBX'], (1, 1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
  ...
  'OMQ_O42_CONTAINER': (
      ...
      (
          ['SAC', SEGMENTS['SAC'], (1, 1), 'SEG'],
          ['OMQ_O42_CONTAINER_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'OMQ_O42_CONTAINER_OBSERVATION': (
      'sequence',
      (
          ['OBX', SEGMENTS['OBX'], (1, 1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
  ...
  'ORU_R40_PATIENT_RESULT': (
      'sequence',
      (
          ['ORU_R40_PATIENT', None, (0, 1), 'GRP'],
          ['ORU_R40_ORDER_OBSERVATION', None, (1, -1), 'GRP'],
      ),
   ),
  'ORU_R40_PATIENT': (
      'sequence',
      (
          ...
          ['NK1', SEGMENTS['NK1'], (0, -1), 'SEG'],
          ['ARV', SEGMENTS['ARV'], (0, -1), 'SEG'],
          ['ORU_R40_PATIENT_OBSERVATION', None, (0, -1), 'GRP'],
          ['ORU_R40_VISIT', None, (0, 1), 'GRP'],
      ),
   ),
  'ORU_R40_PATIENT_OBSERVATION': (
      'sequence',
      (
          ['OBX', SEGMENTS['OBX'], (1, 1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
  ...
  'ORU_R40_ORDER_OBSERVATION': (
      'sequence',
      (
          ['ORU_R40_COMMON_ORDER', None, (0, 1), 'GRP'],
          ['OBR', SEGMENTS['OBR'], (1, 1), 'SEG'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
          ['ORU_R40_TIMING_QTY', None, (0, -1), 'GRP'],
          ['CTD', SEGMENTS['CTD'], (0, 1), 'SEG'],
          ['ORU_R40_OBSERVATION', None, (0, -1), 'GRP'],
          ['FT1', SEGMENTS['FT1'], (0, -1), 'SEG'],
          ['CTI', SEGMENTS['CTI'], (0, -1), 'SEG'],
          ['ORU_R40_SPECIMEN', None, (0, -1), 'GRP'],
      ),
   ),
  'ORU_R40_COMMON_ORDER': (
      'sequence',
      (
          ['ORC', SEGMENTS['ORC'], (0, 1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
          ['ORU_R40_ORDER_DOCUMENT', None, (0, 1), 'GRP'],
      ),
   ),
  'ORU_R40_ORDER_DOCUMENT': (
      'sequence',
      (
          ['OBX', SEGMENTS['OBX'], (1, 1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
  ...
  'ORU_R40_SPECIMEN': (
      ...
      (
          ['SPM', SEGMENTS['SPM'], (1, 1), 'SEG'],
          ['ORU_R40_SPECIMEN_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'ORU_R40_SPECIMEN_OBSERVATION': (
      'sequence',
      (
          ['OBX', SEGMENTS['OBX'], (1, 1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
  ...
  'PEX_P08_EXPERIENCE': (
      ...
      (
          ['PES', SEGMENTS['PES'], (1, 1), 'SEG'],
          ['PEX_P08_PEX_OBSERVATION', None, (1, -1), 'GRP'],
      ),
   ),
  'PEX_P08_PEX_OBSERVATION': (
      'sequence',
      (
          ['PEO', SEGMENTS['PEO'], (1, 1), 'SEG'],
          ['PEX_P08_PEX_CAUSE', None, (1, -1), 'GRP'],
      ),
   ),
  'PEX_P08_PEX_CAUSE': (
      'sequence',
      (
          ['PCR', SEGMENTS['PCR'], (1, 1), 'SEG'],
          ['PEX_P08_RX_ORDER', None, (0, 1), 'GRP'],
          ['PEX_P08_RX_ADMINISTRATION', None, (0, -1), 'GRP'],
          ['PRB', SEGMENTS['PRB'], (0, -1), 'SEG'],
          ['PEX_P08_OBSERVATION', None, (0, -1), 'GRP'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['PEX_P08_ASSOCIATED_PERSON', None, (0, 1), 'GRP'],
          ['PEX_P08_STUDY', None, (0, -1), 'GRP'],
      ),
   ),
  'PEX_P08_RX_ORDER': (
      'sequence',
      (
          ['RXE', SEGMENTS['RXE'], (1, 1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
          ['PEX_P08_TIMING_QTY', None, (1, -1), 'GRP'],
          ['RXR', SEGMENTS['RXR'], (0, -1), 'SEG'],
      ),
   ),
  'PEX_P08_TIMING_QTY': (
  ...
  'PEX_P08_ASSOCIATED_PERSON': (
      ...
      (
          ['NK1', SEGMENTS['NK1'], (1, 1), 'SEG'],
          ['PEX_P08_ASSOCIATED_RX_ORDER', None, (0, 1), 'GRP'],
          ['PEX_P08_ASSOCIATED_RX_ADMIN', None, (0, -1), 'GRP'],
          ['PRB', SEGMENTS['PRB'], (0, -1), 'SEG'],
          ['PEX_P08_ASSOCIATED_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'PEX_P08_ASSOCIATED_RX_ORDER': (
      'sequence',
      (
          ['RXE', SEGMENTS['RXE'], (1, 1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
          ['PEX_P08_NK1_TIMING_QTY', None, (1, -1), 'GRP'],
          ['RXR', SEGMENTS['RXR'], (0, -1), 'SEG'],
      ),
   ),
  'PEX_P08_NK1_TIMING_QTY': (
      'sequence',
      (
          ['TQ1', SEGMENTS['TQ1'], (1, 1), 'SEG'],
          ['TQ2', SEGMENTS['TQ2'], (0, -1), 'SEG'],
  ...
  'PEX_P08_ASSOCIATED_OBSERVATION': (
      'sequence',
      (
          ['OBX', SEGMENTS['OBX'], (1, 1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
  ...
  'PGL_PC7_GOAL': (
      ...
      (
          ...
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PGL_PC7_GOAL_ROLE', None, (0, -1), 'GRP'],
          ['PGL_PC7_PATHWAY', None, (0, -1), 'GRP'],
          ['PGL_PC7_OBSERVATION', None, (0, -1), 'GRP'],
          ['PGL_PC7_PROBLEM', None, (0, -1), 'GRP'],
          ['PGL_PC7_ORDER', None, (0, -1), 'GRP'],
      ),
   ),
  'PGL_PC7_GOAL_ROLE': (
      'sequence',
  ...
  'PGL_PC7_PROBLEM': (
      ...
      (
          ...
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PGL_PC7_PROBLEM_ROLE', None, (0, -1), 'GRP'],
          ['PGL_PC7_PROBLEM_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'PGL_PC7_PROBLEM_ROLE': (
      'sequence',
      (
          ['ROL', SEGMENTS['ROL'], (1, 1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
  ...
  'PGL_PC7_ORDER': (
      ...
      (
          ['ORC', SEGMENTS['ORC'], (1, 1), 'SEG'],
          ['PGL_PC7_ORDER_DETAIL', None, (0, 1), 'GRP'],
      ),
   ),
  'PGL_PC7_ORDER_DETAIL': (
      'sequence',
      (
          ['PGL_PC7_CHOICE', None, (1, 1), 'GRP'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PGL_PC7_ORDER_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'PGL_PC7_CHOICE': (
      'sequence',
  ...
  'PGL_PC8_GOAL': (
      ...
      (
          ...
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PGL_PC8_GOAL_ROLE', None, (0, -1), 'GRP'],
          ['PGL_PC8_PATHWAY', None, (0, -1), 'GRP'],
          ['PGL_PC8_OBSERVATION', None, (0, -1), 'GRP'],
          ['PGL_PC8_PROBLEM', None, (0, -1), 'GRP'],
          ['PGL_PC8_ORDER', None, (0, -1), 'GRP'],
      ),
   ),
  'PGL_PC8_GOAL_ROLE': (
      'sequence',
  ...
  'PGL_PC8_PROBLEM': (
      ...
      (
          ...
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PGL_PC8_PROBLEM_ROLE', None, (0, -1), 'GRP'],
          ['PGL_PC8_PROBLEM_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'PGL_PC8_PROBLEM_ROLE': (
      'sequence',
      (
          ['ROL', SEGMENTS['ROL'], (1, 1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
  ...
  'PGL_PC8_ORDER': (
      ...
      (
          ['ORC', SEGMENTS['ORC'], (1, 1), 'SEG'],
          ['PGL_PC8_ORDER_DETAIL', None, (0, 1), 'GRP'],
      ),
   ),
  'PGL_PC8_ORDER_DETAIL': (
      'sequence',
      (
          ['PGL_PC8_CHOICE', None, (1, 1), 'GRP'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PGL_PC8_ORDER_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'PGL_PC8_CHOICE': (
      'sequence',
  ...
  'PPG_PCH_PATHWAY': (
      ...
      (
          ...
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PPG_PCH_PATHWAY_ROLE', None, (0, -1), 'GRP'],
          ['PPG_PCH_GOAL', None, (0, -1), 'GRP'],
      ),
   ),
  'PPG_PCH_PATHWAY_ROLE': (
      'sequence',
      (
          ['ROL', SEGMENTS['ROL'], (1, 1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
  ...
  'PPG_PCH_GOAL': (
      ...
      (
          ...
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PPG_PCH_GOAL_ROLE', None, (0, -1), 'GRP'],
          ['PPG_PCH_GOAL_OBSERVATION', None, (0, -1), 'GRP'],
          ['PPG_PCH_PROBLEM', None, (0, -1), 'GRP'],
          ['PPG_PCH_ORDER', None, (0, -1), 'GRP'],
      ),
   ),
  'PPG_PCH_GOAL_ROLE': (
      'sequence',
  ...
  'PPG_PCH_PROBLEM': (
      ...
      (
          ...
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PPG_PCH_PROBLEM_ROLE', None, (0, -1), 'GRP'],
          ['PPG_PCH_PROBLEM_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'PPG_PCH_PROBLEM_ROLE': (
      'sequence',
      (
          ['ROL', SEGMENTS['ROL'], (1, 1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
  ...
  'PPG_PCH_ORDER': (
      ...
      (
          ['ORC', SEGMENTS['ORC'], (1, 1), 'SEG'],
          ['PPG_PCH_ORDER_DETAIL', None, (0, 1), 'GRP'],
      ),
   ),
  'PPG_PCH_ORDER_DETAIL': (
      'sequence',
      (
          ['PPG_PCH_CHOICE', None, (1, 1), 'GRP'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PPG_PCH_ORDER_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'PPG_PCH_CHOICE': (
      'sequence',
  ...
  'PPG_PCJ_PATHWAY': (
      ...
      (
          ...
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PPG_PCJ_PATHWAY_ROLE', None, (0, -1), 'GRP'],
          ['PPG_PCJ_GOAL', None, (0, -1), 'GRP'],
      ),
   ),
  'PPG_PCJ_PATHWAY_ROLE': (
      'sequence',
      (
          ['ROL', SEGMENTS['ROL'], (1, 1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
  ...
  'PPG_PCJ_GOAL': (
      ...
      (
          ...
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PPG_PCJ_GOAL_ROLE', None, (0, -1), 'GRP'],
          ['PPG_PCJ_GOAL_OBSERVATION', None, (0, -1), 'GRP'],
          ['PPG_PCJ_PROBLEM', None, (0, -1), 'GRP'],
          ['PPG_PCJ_ORDER', None, (0, -1), 'GRP'],
      ),
   ),
  'PPG_PCJ_GOAL_ROLE': (
      'sequence',
  ...
  'PPG_PCJ_PROBLEM': (
      ...
      (
          ...
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PPG_PCJ_PROBLEM_ROLE', None, (0, -1), 'GRP'],
          ['PPG_PCJ_PROBLEM_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'PPG_PCJ_PROBLEM_ROLE': (
      'sequence',
      (
          ['ROL', SEGMENTS['ROL'], (1, 1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
  ...
  'PPG_PCJ_ORDER': (
      ...
      (
          ['ORC', SEGMENTS['ORC'], (1, 1), 'SEG'],
          ['PPG_PCJ_ORDER_DETAIL', None, (0, 1), 'GRP'],
      ),
   ),
  'PPG_PCJ_ORDER_DETAIL': (
      'sequence',
      (
          ['PPG_PCJ_CHOICE', None, (1, 1), 'GRP'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PPG_PCJ_ORDER_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'PPG_PCJ_CHOICE': (
      'sequence',
  ...
  'PPP_PCC_PATHWAY': (
      ...
      (
          ...
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PPP_PCC_PATHWAY_ROLE', None, (0, -1), 'GRP'],
          ['PPP_PCC_PROBLEM', None, (0, -1), 'GRP'],
      ),
   ),
  'PPP_PCC_PATHWAY_ROLE': (
      'sequence',
      (
          ['ROL', SEGMENTS['ROL'], (1, 1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
  ...
  'PPP_PCC_PROBLEM': (
      ...
      (
          ...
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PPP_PCC_PROBLEM_ROLE', None, (0, -1), 'GRP'],
          ['PPP_PCC_PROBLEM_OBSERVATION', None, (0, -1), 'GRP'],
          ['PPP_PCC_GOAL', None, (0, -1), 'GRP'],
          ['PPP_PCC_ORDER', None, (0, -1), 'GRP'],
      ),
   ),
  'PPP_PCC_PROBLEM_ROLE': (
      'sequence',
      (
          ['ROL', SEGMENTS['ROL'], (1, 1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
  ...
  'PPP_PCC_GOAL': (
      ...
      (
          ...
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PPP_PCC_GOAL_ROLE', None, (0, -1), 'GRP'],
          ['PPP_PCC_GOAL_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'PPP_PCC_GOAL_ROLE': (
      'sequence',
  ...
  'PPP_PCC_ORDER': (
      ...
      (
          ['ORC', SEGMENTS['ORC'], (1, 1), 'SEG'],
          ['PPP_PCC_ORDER_DETAIL', None, (0, 1), 'GRP'],
      ),
   ),
  'PPP_PCC_ORDER_DETAIL': (
      'sequence',
      (
          ['PPP_PCC_CHOICE', None, (1, 1), 'GRP'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PPP_PCC_ORDER_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'PPP_PCC_CHOICE': (
      'sequence',
  ...
  'PPP_PCD_PATHWAY': (
      ...
      (
          ...
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PPP_PCD_PATHWAY_ROLE', None, (0, -1), 'GRP'],
          ['PPP_PCD_PROBLEM', None, (0, -1), 'GRP'],
      ),
   ),
  'PPP_PCD_PATHWAY_ROLE': (
      'sequence',
      (
          ['ROL', SEGMENTS['ROL'], (1, 1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
  ...
  'PPP_PCD_PROBLEM': (
      ...
      (
          ...
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PPP_PCD_PROBLEM_ROLE', None, (0, -1), 'GRP'],
          ['PPP_PCD_PROBLEM_OBSERVATION', None, (0, -1), 'GRP'],
          ['PPP_PCD_GOAL', None, (0, -1), 'GRP'],
          ['PPP_PCD_ORDER', None, (0, -1), 'GRP'],
      ),
   ),
  'PPP_PCD_PROBLEM_ROLE': (
      'sequence',
      (
          ['ROL', SEGMENTS['ROL'], (1, 1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
  ...
  'PPP_PCD_GOAL': (
      ...
      (
          ...
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PPP_PCD_GOAL_ROLE', None, (0, -1), 'GRP'],
          ['PPP_PCD_GOAL_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'PPP_PCD_GOAL_ROLE': (
      'sequence',
  ...
  'PPP_PCD_ORDER': (
      ...
      (
          ['ORC', SEGMENTS['ORC'], (1, 1), 'SEG'],
          ['PPP_PCD_ORDER_DETAIL', None, (0, 1), 'GRP'],
      ),
   ),
  'PPP_PCD_ORDER_DETAIL': (
      'sequence',
      (
          ['PPP_PCD_CHOICE', None, (1, 1), 'GRP'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PPP_PCD_ORDER_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'PPP_PCD_CHOICE': (
      'sequence',
  ...
  'PPR_PC2_PROBLEM': (
      ...
      (
          ...
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PPR_PC2_PROBLEM_ROLE', None, (0, -1), 'GRP'],
          ['PPR_PC2_PATHWAY', None, (0, -1), 'GRP'],
          ['PPR_PC2_PROBLEM_OBSERVATION', None, (0, -1), 'GRP'],
          ['PPR_PC2_GOAL', None, (0, -1), 'GRP'],
          ['PPR_PC2_ORDER', None, (0, -1), 'GRP'],
      ),
   ),
  'PPR_PC2_PROBLEM_ROLE': (
      'sequence',
      (
          ['ROL', SEGMENTS['ROL'], (1, 1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
  ...
  'PPR_PC2_GOAL': (
      ...
      (
          ...
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PPR_PC2_GOAL_ROLE', None, (0, -1), 'GRP'],
          ['PPR_PC2_GOAL_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'PPR_PC2_GOAL_ROLE': (
      'sequence',
  ...
  'PPR_PC2_ORDER': (
      ...
      (
          ['ORC', SEGMENTS['ORC'], (1, 1), 'SEG'],
          ['PPR_PC2_ORDER_DETAIL', None, (0, 1), 'GRP'],
      ),
   ),
  'PPR_PC2_ORDER_DETAIL': (
      'sequence',
      (
          ['PPR_PC2_CHOICE', None, (1, 1), 'GRP'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PPR_PC2_ORDER_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'PPR_PC2_CHOICE': (
      'sequence',
  ...
  'PPR_PC3_PROBLEM': (
      ...
      (
          ...
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PPR_PC3_PROBLEM_ROLE', None, (0, -1), 'GRP'],
          ['PPR_PC3_PATHWAY', None, (0, -1), 'GRP'],
          ['PPR_PC3_PROBLEM_OBSERVATION', None, (0, -1), 'GRP'],
          ['PPR_PC3_GOAL', None, (0, -1), 'GRP'],
          ['PPR_PC3_ORDER', None, (0, -1), 'GRP'],
      ),
   ),
  'PPR_PC3_PROBLEM_ROLE': (
      'sequence',
      (
          ['ROL', SEGMENTS['ROL'], (1, 1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
  ...
  'PPR_PC3_GOAL': (
      ...
      (
          ...
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PPR_PC3_GOAL_ROLE', None, (0, -1), 'GRP'],
          ['PPR_PC3_GOAL_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'PPR_PC3_GOAL_ROLE': (
      'sequence',
  ...
  'PPR_PC3_ORDER': (
      ...
      (
          ['ORC', SEGMENTS['ORC'], (1, 1), 'SEG'],
          ['PPR_PC3_ORDER_DETAIL', None, (0, 1), 'GRP'],
      ),
   ),
  'PPR_PC3_ORDER_DETAIL': (
      'sequence',
      (
          ['PPR_PC3_CHOICE', None, (1, 1), 'GRP'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PPR_PC3_ORDER_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'PPR_PC3_CHOICE': (
      'sequence',
  ...
  'RDE_O11_ORDER': (
      ...
      (
          ...
          ['RDE_O11_INFUSION_ORDER', None, (0, 1), 'GRP'],
          ['RXR', SEGMENTS['RXR'], (1, -1), 'SEG'],
          ['RXC', SEGMENTS['RXC'], (0, -1), 'SEG'],
          ['CDO', SEGMENTS['CDO'], (0, -1), 'SEG'],
  ...
  'RDE_O25_PATIENT': (
      ...
      (
          ...
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['ARV', SEGMENTS['ARV'], (0, -1), 'SEG'],
          ['RDE_O25_PATIENT_VISIT', None, (0, 1), 'GRP'],
          ['RDE_O25_INSURANCE', None, (0, -1), 'GRP'],
          ['GT1', SEGMENTS['GT1'], (0, 1), 'SEG'],
          ['AL1', SEGMENTS['AL1'], (0, -1), 'SEG'],
      ),
   ),
  'RDE_O25_PATIENT_VISIT': (
      'sequence',
      (
          ['PV1', SEGMENTS['PV1'], (1, 1), 'SEG'],
          ['PV2', SEGMENTS['PV2'], (0, 1), 'SEG'],
  ...
  'RDE_O25_ORDER': (
      ...
      (
          ['ORC', SEGMENTS['ORC'], (1, 1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
          ['RDE_O25_TIMING', None, (0, -1), 'GRP'],
          ['RDE_O25_ORDER_DETAIL', None, (0, 1), 'GRP'],
          ['RXE', SEGMENTS['RXE'], (1, 1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['RDE_O25_TIMING_ENCODED', None, (1, -1), 'GRP'],
          ['RDE_O25_INFUSION_ORDER', None, (0, -1), 'GRP'],
          ['RXR', SEGMENTS['RXR'], (1, -1), 'SEG'],
          ['RXC', SEGMENTS['RXC'], (0, -1), 'SEG'],
          ['CDO', SEGMENTS['CDO'], (0, -1), 'SEG'],
          ['RDE_O25_OBSERVATION', None, (0, -1), 'GRP'],
          ['FT1', SEGMENTS['FT1'], (0, -1), 'SEG'],
          ['BLG', SEGMENTS['BLG'], (0, 1), 'SEG'],
          ['CTI', SEGMENTS['CTI'], (0, -1), 'SEG'],
      ),
  ...
  'RDE_O25_ORDER_DETAIL': (
      'sequence',
      (
          ['RXO', SEGMENTS['RXO'], (1, 1), 'SEG'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['RXR', SEGMENTS['RXR'], (1, -1), 'SEG'],
          ['RDE_O25_COMPONENT', None, (0, -1), 'GRP'],
      ),
   ),
  'RDE_O25_COMPONENT': (
      'sequence',
  ...
  'REF_I13_PROCEDURE': (
      ...
      (
          ['PR1', SEGMENTS['PR1'], (1, 1), 'SEG'],
          ['REF_I13_AUTHORIZATION_CONTACT2', None, (0, 1), 'GRP'],
      ),
   ),
  'REF_I13_AUTHORIZATION_CONTACT2': (
      'sequence',
      (
          ['AUT', SEGMENTS['AUT'], (1, 1), 'SEG'],
          ['CTD', SEGMENTS['CTD'], (0, 1), 'SEG'],
  ...
  'REF_I13_OBSERVATION': (
      ...
      (
          ['OBR', SEGMENTS['OBR'], (1, 1), 'SEG'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['REF_I13_RESULTS_NOTES', None, (0, -1), 'GRP'],
      ),
   ),
  'REF_I13_RESULTS_NOTES': (
      'sequence',
      (
          ['OBX', SEGMENTS['OBX'], (1, 1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
  ...
  'REF_I14_PROCEDURE': (
      ...
      (
          ['PR1', SEGMENTS['PR1'], (1, 1), 'SEG'],
          ['REF_I14_AUTHORIZATION_CONTACT2', None, (0, 1), 'GRP'],
      ),
   ),
  'REF_I14_AUTHORIZATION_CONTACT2': (
      'sequence',
      (
          ['AUT', SEGMENTS['AUT'], (1, 1), 'SEG'],
          ['CTD', SEGMENTS['CTD'], (0, 1), 'SEG'],
  ...
  'REF_I14_OBSERVATION': (
      ...
      (
          ['OBR', SEGMENTS['OBR'], (1, 1), 'SEG'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['REF_I14_RESULTS_NOTES', None, (0, -1), 'GRP'],
      ),
   ),
  'REF_I14_RESULTS_NOTES': (
      'sequence',
      (
          ['OBX', SEGMENTS['OBX'], (1, 1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
  ...
  'REF_I15_PROCEDURE': (
      ...
      (
          ['PR1', SEGMENTS['PR1'], (1, 1), 'SEG'],
          ['REF_I15_AUTHORIZATION_CONTACT2', None, (0, 1), 'GRP'],
      ),
   ),
  'REF_I15_AUTHORIZATION_CONTACT2': (
      'sequence',
      (
          ['AUT', SEGMENTS['AUT'], (1, 1), 'SEG'],
          ['CTD', SEGMENTS['CTD'], (0, 1), 'SEG'],
  ...
  'REF_I15_OBSERVATION': (
      ...
      (
          ['OBR', SEGMENTS['OBR'], (1, 1), 'SEG'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['REF_I15_RESULTS_NOTES', None, (0, -1), 'GRP'],
      ),
   ),
  'REF_I15_RESULTS_NOTES': (
      'sequence',
      (
          ['OBX', SEGMENTS['OBX'], (1, 1), 'SEG'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
  ...
  'RPA_I08_PROCEDURE': (
      ...
      (
          ['PR1', SEGMENTS['PR1'], (1, 1), 'SEG'],
          ['RPA_I08_AUTHORIZATION2', None, (0, 1), 'GRP'],
      ),
   ),
  ...
  'RPA_I09_PROCEDURE': (
      ...
      (
          ['PR1', SEGMENTS['PR1'], (1, 1), 'SEG'],
          ['RPA_I09_AUTHORIZATION_2', None, (0, 1), 'GRP'],
      ),
   ),
  'RPA_I09_AUTHORIZATION_2': (
      'sequence',
      (
          ['AUT', SEGMENTS['AUT'], (1, 1), 'SEG'],
          ['CTD', SEGMENTS['CTD'], (0, 1), 'SEG'],
  ...
  'RPA_I10_PROCEDURE': (
      ...
      (
          ['PR1', SEGMENTS['PR1'], (1, 1), 'SEG'],
          ['RPA_I10_AUTHORIZATION_2', None, (0, 1), 'GRP'],
      ),
   ),
  'RPA_I10_AUTHORIZATION_2': (
      'sequence',
      (
          ['AUT', SEGMENTS['AUT'], (1, 1), 'SEG'],
          ['CTD', SEGMENTS['CTD'], (0, 1), 'SEG'],
  ...
  'RPA_I11_PROCEDURE': (
      ...
      (
          ['PR1', SEGMENTS['PR1'], (1, 1), 'SEG'],
          ['RPA_I11_AUTHORIZATION_2', None, (0, 1), 'GRP'],
      ),
   ),
  'RPA_I11_AUTHORIZATION_2': (
      'sequence',
      (
          ['AUT', SEGMENTS['AUT'], (1, 1), 'SEG'],
          ['CTD', SEGMENTS['CTD'], (0, 1), 'SEG'],
  ...
  'RQA_I08_PROCEDURE': (
      ...
      (
          ['PR1', SEGMENTS['PR1'], (1, 1), 'SEG'],
          ['RQA_I08_AUTHORIZATION2', None, (0, 1), 'GRP'],
      ),
   ),
  ...
  'RQA_I09_GUARANTOR_INSURANCE': (
      ...
      (
          ['GT1', SEGMENTS['GT1'], (0, -1), 'SEG'],
          ['RQA_I09_INSURANCE', None, (1, -1), 'GRP'],
      ),
   ),
  'RQA_I09_INSURANCE': (
      'sequence',
  ...
  'RQA_I09_PROCEDURE': (
      ...
      (
          ['PR1', SEGMENTS['PR1'], (1, 1), 'SEG'],
          ['RQA_I09_AUTHORIZATION2', None, (0, 1), 'GRP'],
      ),
   ),
  'RQA_I09_AUTHORIZATION2': (
      'sequence',
      (
          ['AUT', SEGMENTS['AUT'], (1, 1), 'SEG'],
          ['CTD', SEGMENTS['CTD'], (0, 1), 'SEG'],
  ...
  'RQA_I10_GUARANTOR_INSURANCE': (
      ...
      (
          ['GT1', SEGMENTS['GT1'], (0, -1), 'SEG'],
          ['RQA_I10_INSURANCE', None, (1, -1), 'GRP'],
      ),
   ),
  'RQA_I10_INSURANCE': (
      'sequence',
  ...
  'RQA_I10_PROCEDURE': (
      ...
      (
          ['PR1', SEGMENTS['PR1'], (1, 1), 'SEG'],
          ['RQA_I10_AUTHORIZATION2', None, (0, 1), 'GRP'],
      ),
   ),
  'RQA_I10_AUTHORIZATION2': (
      'sequence',
      (
          ['AUT', SEGMENTS['AUT'], (1, 1), 'SEG'],
          ['CTD', SEGMENTS['CTD'], (0, 1), 'SEG'],
  ...
  'RQA_I11_GUARANTOR_INSURANCE': (
      ...
      (
          ['GT1', SEGMENTS['GT1'], (0, -1), 'SEG'],
          ['RQA_I11_INSURANCE', None, (1, -1), 'GRP'],
      ),
   ),
  'RQA_I11_INSURANCE': (
      'sequence',
  ...
  'RQA_I11_PROCEDURE': (
      ...
      (
          ['PR1', SEGMENTS['PR1'], (1, 1), 'SEG'],
          ['RQA_I11_AUTHORIZATION2', None, (0, 1), 'GRP'],
      ),
   ),
  'RQA_I11_AUTHORIZATION2': (
      'sequence',
      (
          ['AUT', SEGMENTS['AUT'], (1, 1), 'SEG'],
          ['CTD', SEGMENTS['CTD'], (0, 1), 'SEG'],
  ...
  'RQI_I02_GUARANTOR_INSURANCE': (
      ...
      (
          ['GT1', SEGMENTS['GT1'], (0, -1), 'SEG'],
          ['RQI_I02_INSURANCE', None, (1, -1), 'GRP'],
      ),
   ),
  'RQI_I02_INSURANCE': (
      'sequence',
  ...
  'RQI_I03_GUARANTOR_INSURANCE': (
      ...
      (
          ['GT1', SEGMENTS['GT1'], (0, -1), 'SEG'],
          ['RQI_I03_INSURANCE', None, (1, -1), 'GRP'],
      ),
   ),
  'RQI_I03_INSURANCE': (
      'sequence',
  ...
  'RRE_O26_RESPONSE': (
      'sequence',
      (
          ['RRE_O26_PATIENT', None, (0, 1), 'GRP'],
          ['RRE_O26_ORDER', None, (1, -1), 'GRP'],
      ),
   ),
  'RRE_O26_PATIENT': (
      'sequence',
  ...
  'RRE_O26_ORDER': (
      ...
      (
          ['ORC', SEGMENTS['ORC'], (1, 1), 'SEG'],
          ['RRE_O26_TIMING', None, (0, -1), 'GRP'],
          ['RRE_O26_ENCODING', None, (0, 1), 'GRP'],
          ['PRT', SEGMENTS['PRT'], (0, -1), 'SEG'],
      ),
   ),
  'RRE_O26_TIMING': (
  ...
  'RRE_O26_ENCODING': (
      ...
      (
          ['RXE', SEGMENTS['RXE'], (1, 1), 'SEG'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['RRE_O26_TIMING_ENCODED', None, (1, -1), 'GRP'],
          ['RXR', SEGMENTS['RXR'], (1, -1), 'SEG'],
          ['RXC', SEGMENTS['RXC'], (0, -1), 'SEG'],
      ),
   ),
  'RRE_O26_TIMING_ENCODED': (
      'sequence',
      (
          ['TQ1', SEGMENTS['TQ1'], (1, 1), 'SEG'],
          ['TQ2', SEGMENTS['TQ2'], (0, -1), 'SEG'],
  ...
  'RRI_I13_PROCEDURE': (
      ...
      (
          ['PR1', SEGMENTS['PR1'], (1, 1), 'SEG'],
          ['RRI_I13_AUTHORIZATION_CONTACT', None, (0, 1), 'GRP'],
      ),
   ),
  'RRI_I13_AUTHORIZATION_CONTACT': (
      'sequence',
  ...
  'RRI_I13_OBSERVATION': (
      ...
      (
          ['OBR', SEGMENTS['OBR'], (1, 1), 'SEG'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['RRI_I13_RESULTS_NOTES', None, (0, -1), 'GRP'],
      ),
   ),
  'RRI_I13_RESULTS_NOTES': (
      'sequence',
      (
          ['OBX', SEGMENTS['OBX'], (1, 1), 'SEG'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
  ...
  'RRI_I14_PROCEDURE': (
      ...
      (
          ['PR1', SEGMENTS['PR1'], (1, 1), 'SEG'],
          ['RRI_I14_AUTHORIZATION_CONTACT', None, (0, 1), 'GRP'],
      ),
   ),
  'RRI_I14_AUTHORIZATION_CONTACT': (
      'sequence',
  ...
  'RRI_I14_OBSERVATION': (
      ...
      (
          ['OBR', SEGMENTS['OBR'], (1, 1), 'SEG'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['RRI_I14_RESULTS_NOTES', None, (0, -1), 'GRP'],
      ),
   ),
  'RRI_I14_RESULTS_NOTES': (
      'sequence',
      (
          ['OBX', SEGMENTS['OBX'], (1, 1), 'SEG'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
  ...
  'RRI_I15_PROCEDURE': (
      ...
      (
          ['PR1', SEGMENTS['PR1'], (1, 1), 'SEG'],
          ['RRI_I15_AUTHORIZATION_CONTACT', None, (0, 1), 'GRP'],
      ),
   ),
  'RRI_I15_AUTHORIZATION_CONTACT': (
      'sequence',
  ...
  'RRI_I15_OBSERVATION': (
      ...
      (
          ['OBR', SEGMENTS['OBR'], (1, 1), 'SEG'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['RRI_I15_RESULTS_NOTES', None, (0, -1), 'GRP'],
      ),
   ),
  'RRI_I15_RESULTS_NOTES': (
      'sequence',
      (
          ['OBX', SEGMENTS['OBX'], (1, 1), 'SEG'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
  ...
  'RSP_K34_DONNOR': (
      ...
      (
          ...
          ['AL1', SEGMENTS['AL1'], (0, -1), 'SEG'],
          ['ARV', SEGMENTS['ARV'], (0, -1), 'SEG'],
          ['RSP_K34_DONNOR_REGISTRATION', None, (0, 1), 'GRP'],
      ),
   ),
  'RSP_K34_DONNOR_REGISTRATION': (
      'sequence',
      (
          ['PV1', SEGMENTS['PV1'], (0, 1), 'SEG'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
  ...
  'SCN_S37_ANTI-MICROBIAL_DEVICE_CYCLE_DATA': (
      'sequence',
      (
  ...
  'SDN_S36_ANTI-MICROBIAL_DEVICE_DATA': (
      'sequence',
      (
          ['SDD', SEGMENTS['SDD'], (1, 1), 'SEG'],
          ['SCD', SEGMENTS['SCD'], (0, -1), 'SEG'],
  ...
  'SMD_S32_ANTI-MICROBIAL_DEVICE_CYCLE_DATA': (
      'sequence',
      (
          ['SDD', SEGMENTS['SDD'], (1, 1), 'SEG'],
          ['SCD', SEGMENTS['SCD'], (0, -1), 'SEG'],
  ...
  'SRM_S02_PATIENT': (
      ...
      (
          ...
          ['PV1', SEGMENTS['PV1'], (0, 1), 'SEG'],
          ['PV2', SEGMENTS['PV2'], (0, 1), 'SEG'],
          ['SRM_S02_OBSERVATION', None, (0, -1), 'GRP'],
          ['DG1', SEGMENTS['DG1'], (0, -1), 'SEG'],
      ),
   ),
  'SRM_S02_OBSERVATION': (
  ...
  'SRM_S02_RESOURCES': (
      ...
      (
          ['RGS', SEGMENTS['RGS'], (1, 1), 'SEG'],
          ['SRM_S02_SERVICE', None, (0, -1), 'GRP'],
          ['SRM_S02_GENERAL_RESOURCE', None, (0, -1), 'GRP'],
          ['SRM_S02_LOCATION_RESOURCE', None, (0, -1), 'GRP'],
          ['SRM_S02_PERSONNEL_RESOURCE', None, (0, -1), 'GRP'],
      ),
   ),
  'SRM_S02_SERVICE': (
      'sequence',
  ...
  'SRM_S03_PATIENT': (
      ...
      (
          ...
          ['PV1', SEGMENTS['PV1'], (0, 1), 'SEG'],
          ['PV2', SEGMENTS['PV2'], (0, 1), 'SEG'],
          ['SRM_S03_OBSERVATION', None, (0, -1), 'GRP'],
          ['DG1', SEGMENTS['DG1'], (0, -1), 'SEG'],
      ),
   ),
  'SRM_S03_OBSERVATION': (
  ...
  'SRM_S03_RESOURCES': (
      ...
      (
          ['RGS', SEGMENTS['RGS'], (1, 1), 'SEG'],
          ['SRM_S03_SERVICE', None, (0, -1), 'GRP'],
          ['SRM_S03_GENERAL_RESOURCE', None, (0, -1), 'GRP'],
          ['SRM_S03_LOCATION_RESOURCE', None, (0, -1), 'GRP'],
          ['SRM_S03_PERSONNEL_RESOURCE', None, (0, -1), 'GRP'],
      ),
   ),
  'SRM_S03_SERVICE': (
      'sequence',
  ...
  'SRM_S04_PATIENT': (
      ...
      (
          ...
          ['PV1', SEGMENTS['PV1'], (0, 1), 'SEG'],
          ['PV2', SEGMENTS['PV2'], (0, 1), 'SEG'],
          ['SRM_S04_OBSERVATION', None, (0, -1), 'GRP'],
          ['DG1', SEGMENTS['DG1'], (0, -1), 'SEG'],
      ),
   ),
  'SRM_S04_OBSERVATION': (
  ...
  'SRM_S04_RESOURCES': (
      ...
      (
          ['RGS', SEGMENTS['RGS'], (1, 1), 'SEG'],
          ['SRM_S04_SERVICE', None, (0, -1), 'GRP'],
          ['SRM_S04_GENERAL_RESOURCE', None, (0, -1), 'GRP'],
          ['SRM_S04_LOCATION_RESOURCE', None, (0, -1), 'GRP'],
          ['SRM_S04_PERSONNEL_RESOURCE', None, (0, -1), 'GRP'],
      ),
   ),
  'SRM_S04_SERVICE': (
      'sequence',
  ...
  'SRM_S05_PATIENT': (
      ...
      (
          ...
          ['PV1', SEGMENTS['PV1'], (0, 1), 'SEG'],
          ['PV2', SEGMENTS['PV2'], (0, 1), 'SEG'],
          ['SRM_S05_OBSERVATION', None, (0, -1), 'GRP'],
          ['DG1', SEGMENTS['DG1'], (0, -1), 'SEG'],
      ),
   ),
  'SRM_S05_OBSERVATION': (
  ...
  'SRM_S05_RESOURCES': (
      ...
      (
          ['RGS', SEGMENTS['RGS'], (1, 1), 'SEG'],
          ['SRM_S05_SERVICE', None, (0, -1), 'GRP'],
          ['SRM_S05_GENERAL_RESOURCE', None, (0, -1), 'GRP'],
          ['SRM_S05_LOCATION_RESOURCE', None, (0, -1), 'GRP'],
          ['SRM_S05_PERSONNEL_RESOURCE', None, (0, -1), 'GRP'],
      ),
   ),
  'SRM_S05_SERVICE': (
      'sequence',
  ...
  'SRM_S06_PATIENT': (
      ...
      (
          ...
          ['PV1', SEGMENTS['PV1'], (0, 1), 'SEG'],
          ['PV2', SEGMENTS['PV2'], (0, 1), 'SEG'],
          ['SRM_S06_OBSERVATION', None, (0, -1), 'GRP'],
          ['DG1', SEGMENTS['DG1'], (0, -1), 'SEG'],
      ),
   ),
  'SRM_S06_OBSERVATION': (
  ...
  'SRM_S06_RESOURCES': (
      ...
      (
          ['RGS', SEGMENTS['RGS'], (1, 1), 'SEG'],
          ['SRM_S06_SERVICE', None, (0, -1), 'GRP'],
          ['SRM_S06_GENERAL_RESOURCE', None, (0, -1), 'GRP'],
          ['SRM_S06_LOCATION_RESOURCE', None, (0, -1), 'GRP'],
          ['SRM_S06_PERSONNEL_RESOURCE', None, (0, -1), 'GRP'],
      ),
   ),
  'SRM_S06_SERVICE': (
      'sequence',
  ...
  'SRM_S07_PATIENT': (
      ...
      (
          ...
          ['PV1', SEGMENTS['PV1'], (0, 1), 'SEG'],
          ['PV2', SEGMENTS['PV2'], (0, 1), 'SEG'],
          ['SRM_S07_OBSERVATION', None, (0, -1), 'GRP'],
          ['DG1', SEGMENTS['DG1'], (0, -1), 'SEG'],
      ),
   ),
  'SRM_S07_OBSERVATION': (
  ...
  'SRM_S07_RESOURCES': (
      ...
      (
          ['RGS', SEGMENTS['RGS'], (1, 1), 'SEG'],
          ['SRM_S07_SERVICE', None, (0, -1), 'GRP'],
          ['SRM_S07_GENERAL_RESOURCE', None, (0, -1), 'GRP'],
          ['SRM_S07_LOCATION_RESOURCE', None, (0, -1), 'GRP'],
          ['SRM_S07_PERSONNEL_RESOURCE', None, (0, -1), 'GRP'],
      ),
   ),
  'SRM_S07_SERVICE': (
      'sequence',
  ...
  'SRM_S08_PATIENT': (
      ...
      (
          ...
          ['PV1', SEGMENTS['PV1'], (0, 1), 'SEG'],
          ['PV2', SEGMENTS['PV2'], (0, 1), 'SEG'],
          ['SRM_S08_OBSERVATION', None, (0, -1), 'GRP'],
          ['DG1', SEGMENTS['DG1'], (0, -1), 'SEG'],
      ),
   ),
  'SRM_S08_OBSERVATION': (
  ...
  'SRM_S08_RESOURCES': (
      ...
      (
          ['RGS', SEGMENTS['RGS'], (1, 1), 'SEG'],
          ['SRM_S08_SERVICE', None, (0, -1), 'GRP'],
          ['SRM_S08_GENERAL_RESOURCE', None, (0, -1), 'GRP'],
          ['SRM_S08_LOCATION_RESOURCE', None, (0, -1), 'GRP'],
          ['SRM_S08_PERSONNEL_RESOURCE', None, (0, -1), 'GRP'],
      ),
   ),
  'SRM_S08_SERVICE': (
      'sequence',
  ...
  'SRM_S09_PATIENT': (
      ...
      (
          ...
          ['PV1', SEGMENTS['PV1'], (0, 1), 'SEG'],
          ['PV2', SEGMENTS['PV2'], (0, 1), 'SEG'],
          ['SRM_S09_OBSERVATION', None, (0, -1), 'GRP'],
          ['DG1', SEGMENTS['DG1'], (0, -1), 'SEG'],
      ),
   ),
  'SRM_S09_OBSERVATION': (
  ...
  'SRM_S09_RESOURCES': (
      ...
      (
          ['RGS', SEGMENTS['RGS'], (1, 1), 'SEG'],
          ['SRM_S09_SERVICE', None, (0, -1), 'GRP'],
          ['SRM_S09_GENERAL_RESOURCE', None, (0, -1), 'GRP'],
          ['SRM_S09_LOCATION_RESOURCE', None, (0, -1), 'GRP'],
          ['SRM_S09_PERSONNEL_RESOURCE', None, (0, -1), 'GRP'],
      ),
   ),
  'SRM_S09_SERVICE': (
      'sequence',
  ...
  'SRM_S10_PATIENT': (
      ...
      (
          ...
          ['PV1', SEGMENTS['PV1'], (0, 1), 'SEG'],
          ['PV2', SEGMENTS['PV2'], (0, 1), 'SEG'],
          ['SRM_S10_OBSERVATION', None, (0, -1), 'GRP'],
          ['DG1', SEGMENTS['DG1'], (0, -1), 'SEG'],
      ),
   ),
  'SRM_S10_OBSERVATION': (
  ...
  'SRM_S10_RESOURCES': (
      ...
      (
          ['RGS', SEGMENTS['RGS'], (1, 1), 'SEG'],
          ['SRM_S10_SERVICE', None, (0, -1), 'GRP'],
          ['SRM_S10_GENERAL_RESOURCE', None, (0, -1), 'GRP'],
          ['SRM_S10_LOCATION_RESOURCE', None, (0, -1), 'GRP'],
          ['SRM_S10_PERSONNEL_RESOURCE', None, (0, -1), 'GRP'],
      ),
   ),
  'SRM_S10_SERVICE': (
      'sequence',
  ...
  'SRM_S11_PATIENT': (
      ...
      (
          ...
          ['PV1', SEGMENTS['PV1'], (0, 1), 'SEG'],
          ['PV2', SEGMENTS['PV2'], (0, 1), 'SEG'],
          ['SRM_S11_OBSERVATION', None, (0, -1), 'GRP'],
          ['DG1', SEGMENTS['DG1'], (0, -1), 'SEG'],
      ),
   ),
  'SRM_S11_OBSERVATION': (
  ...
  'SRM_S11_RESOURCES': (
      ...
      (
          ['RGS', SEGMENTS['RGS'], (1, 1), 'SEG'],
          ['SRM_S11_SERVICE', None, (0, -1), 'GRP'],
          ['SRM_S11_GENERAL_RESOURCE', None, (0, -1), 'GRP'],
          ['SRM_S11_LOCATION_RESOURCE', None, (0, -1), 'GRP'],
          ['SRM_S11_PERSONNEL_RESOURCE', None, (0, -1), 'GRP'],
      ),
   ),
  'SRM_S11_SERVICE': (
      'sequence',
  ...
  'SRR_S02_SCHEDULE': (
      ...
      (
          ...
          ['TQ1', SEGMENTS['TQ1'], (0, -1), 'SEG'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['SRR_S02_PATIENT', None, (0, -1), 'GRP'],
          ['SRR_S02_RESOURCES', None, (1, -1), 'GRP'],
      ),
   ),
  'SRR_S02_PATIENT': (
      'sequence',
  ...
  'SRR_S02_RESOURCES': (
      ...
      (
          ['RGS', SEGMENTS['RGS'], (1, 1), 'SEG'],
          ['SRR_S02_SERVICE', None, (0, -1), 'GRP'],
          ['SRR_S02_GENERAL_RESOURCE', None, (0, -1), 'GRP'],
          ['SRR_S02_LOCATION_RESOURCE', None, (0, -1), 'GRP'],
          ['SRR_S02_PERSONNEL_RESOURCE', None, (0, -1), 'GRP'],
      ),
   ),
  'SRR_S02_SERVICE': (
      'sequence',
  ...
  'SRR_S03_SCHEDULE': (
      ...
      (
          ...
          ['TQ1', SEGMENTS['TQ1'], (0, -1), 'SEG'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['SRR_S03_PATIENT', None, (0, -1), 'GRP'],
          ['SRR_S03_RESOURCES', None, (1, -1), 'GRP'],
      ),
   ),
  'SRR_S03_PATIENT': (
      'sequence',
  ...
  'SRR_S03_RESOURCES': (
      ...
      (
          ['RGS', SEGMENTS['RGS'], (1, 1), 'SEG'],
          ['SRR_S03_SERVICE', None, (0, -1), 'GRP'],
          ['SRR_S03_GENERAL_RESOURCE', None, (0, -1), 'GRP'],
          ['SRR_S03_LOCATION_RESOURCE', None, (0, -1), 'GRP'],
          ['SRR_S03_PERSONNEL_RESOURCE', None, (0, -1), 'GRP'],
      ),
   ),
  'SRR_S03_SERVICE': (
      'sequence',
  ...
  'SRR_S04_SCHEDULE': (
      ...
      (
          ...
          ['TQ1', SEGMENTS['TQ1'], (0, -1), 'SEG'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['SRR_S04_PATIENT', None, (0, -1), 'GRP'],
          ['SRR_S04_RESOURCES', None, (1, -1), 'GRP'],
      ),
   ),
  'SRR_S04_PATIENT': (
      'sequence',
  ...
  'SRR_S04_RESOURCES': (
      ...
      (
          ['RGS', SEGMENTS['RGS'], (1, 1), 'SEG'],
          ['SRR_S04_SERVICE', None, (0, -1), 'GRP'],
          ['SRR_S04_GENERAL_RESOURCE', None, (0, -1), 'GRP'],
          ['SRR_S04_LOCATION_RESOURCE', None, (0, -1), 'GRP'],
          ['SRR_S04_PERSONNEL_RESOURCE', None, (0, -1), 'GRP'],
      ),
   ),
  'SRR_S04_SERVICE': (
      'sequence',
  ...
  'SRR_S05_SCHEDULE': (
      ...
      (
          ...
          ['TQ1', SEGMENTS['TQ1'], (0, -1), 'SEG'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['SRR_S05_PATIENT', None, (0, -1), 'GRP'],
          ['SRR_S05_RESOURCES', None, (1, -1), 'GRP'],
      ),
   ),
  'SRR_S05_PATIENT': (
      'sequence',
  ...
  'SRR_S05_RESOURCES': (
      ...
      (
          ['RGS', SEGMENTS['RGS'], (1, 1), 'SEG'],
          ['SRR_S05_SERVICE', None, (0, -1), 'GRP'],
          ['SRR_S05_GENERAL_RESOURCE', None, (0, -1), 'GRP'],
          ['SRR_S05_LOCATION_RESOURCE', None, (0, -1), 'GRP'],
          ['SRR_S05_PERSONNEL_RESOURCE', None, (0, -1), 'GRP'],
      ),
   ),
  'SRR_S05_SERVICE': (
      'sequence',
  ...
  'SRR_S06_SCHEDULE': (
      ...
      (
          ...
          ['TQ1', SEGMENTS['TQ1'], (0, -1), 'SEG'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['SRR_S06_PATIENT', None, (0, -1), 'GRP'],
          ['SRR_S06_RESOURCES', None, (1, -1), 'GRP'],
      ),
   ),
  'SRR_S06_PATIENT': (
      'sequence',
  ...
  'SRR_S06_RESOURCES': (
      ...
      (
          ['RGS', SEGMENTS['RGS'], (1, 1), 'SEG'],
          ['SRR_S06_SERVICE', None, (0, -1), 'GRP'],
          ['SRR_S06_GENERAL_RESOURCE', None, (0, -1), 'GRP'],
          ['SRR_S06_LOCATION_RESOURCE', None, (0, -1), 'GRP'],
          ['SRR_S06_PERSONNEL_RESOURCE', None, (0, -1), 'GRP'],
      ),
   ),
  'SRR_S06_SERVICE': (
      'sequence',
  ...
  'SRR_S07_SCHEDULE': (
      ...
      (
          ...
          ['TQ1', SEGMENTS['TQ1'], (0, -1), 'SEG'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['SRR_S07_PATIENT', None, (0, -1), 'GRP'],
          ['SRR_S07_RESOURCES', None, (1, -1), 'GRP'],
      ),
   ),
  'SRR_S07_PATIENT': (
      'sequence',
  ...
  'SRR_S07_RESOURCES': (
      ...
      (
          ['RGS', SEGMENTS['RGS'], (1, 1), 'SEG'],
          ['SRR_S07_SERVICE', None, (0, -1), 'GRP'],
          ['SRR_S07_GENERAL_RESOURCE', None, (0, -1), 'GRP'],
          ['SRR_S07_LOCATION_RESOURCE', None, (0, -1), 'GRP'],
          ['SRR_S07_PERSONNEL_RESOURCE', None, (0, -1), 'GRP'],
      ),
   ),
  'SRR_S07_SERVICE': (
      'sequence',
  ...
  'SRR_S08_SCHEDULE': (
      ...
      (
          ...
          ['TQ1', SEGMENTS['TQ1'], (0, -1), 'SEG'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['SRR_S08_PATIENT', None, (0, -1), 'GRP'],
          ['SRR_S08_RESOURCES', None, (1, -1), 'GRP'],
      ),
   ),
  'SRR_S08_PATIENT': (
      'sequence',
  ...
  'SRR_S08_RESOURCES': (
      ...
      (
          ['RGS', SEGMENTS['RGS'], (1, 1), 'SEG'],
          ['SRR_S08_SERVICE', None, (0, -1), 'GRP'],
          ['SRR_S08_GENERAL_RESOURCE', None, (0, -1), 'GRP'],
          ['SRR_S08_LOCATION_RESOURCE', None, (0, -1), 'GRP'],
          ['SRR_S08_PERSONNEL_RESOURCE', None, (0, -1), 'GRP'],
      ),
   ),
  'SRR_S08_SERVICE': (
      'sequence',
  ...
  'SRR_S09_SCHEDULE': (
      ...
      (
          ...
          ['TQ1', SEGMENTS['TQ1'], (0, -1), 'SEG'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['SRR_S09_PATIENT', None, (0, -1), 'GRP'],
          ['SRR_S09_RESOURCES', None, (1, -1), 'GRP'],
      ),
   ),
  'SRR_S09_PATIENT': (
      'sequence',
  ...
  'SRR_S09_RESOURCES': (
      ...
      (
          ['RGS', SEGMENTS['RGS'], (1, 1), 'SEG'],
          ['SRR_S09_SERVICE', None, (0, -1), 'GRP'],
          ['SRR_S09_GENERAL_RESOURCE', None, (0, -1), 'GRP'],
          ['SRR_S09_LOCATION_RESOURCE', None, (0, -1), 'GRP'],
          ['SRR_S09_PERSONNEL_RESOURCE', None, (0, -1), 'GRP'],
      ),
   ),
  'SRR_S09_SERVICE': (
      'sequence',
  ...
  'SRR_S10_SCHEDULE': (
      ...
      (
          ...
          ['TQ1', SEGMENTS['TQ1'], (0, -1), 'SEG'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['SRR_S10_PATIENT', None, (0, -1), 'GRP'],
          ['SRR_S10_RESOURCES', None, (1, -1), 'GRP'],
      ),
   ),
  'SRR_S10_PATIENT': (
      'sequence',
  ...
  'SRR_S10_RESOURCES': (
      ...
      (
          ['RGS', SEGMENTS['RGS'], (1, 1), 'SEG'],
          ['SRR_S10_SERVICE', None, (0, -1), 'GRP'],
          ['SRR_S10_GENERAL_RESOURCE', None, (0, -1), 'GRP'],
          ['SRR_S10_LOCATION_RESOURCE', None, (0, -1), 'GRP'],
          ['SRR_S10_PERSONNEL_RESOURCE', None, (0, -1), 'GRP'],
      ),
   ),
  'SRR_S10_SERVICE': (
      'sequence',
  ...
  'SRR_S11_SCHEDULE': (
      ...
      (
          ...
          ['TQ1', SEGMENTS['TQ1'], (0, -1), 'SEG'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['SRR_S11_PATIENT', None, (0, -1), 'GRP'],
          ['SRR_S11_RESOURCES', None, (1, -1), 'GRP'],
      ),
   ),
  'SRR_S11_PATIENT': (
      'sequence',
  ...
  'SRR_S11_RESOURCES': (
      ...
      (
          ['RGS', SEGMENTS['RGS'], (1, 1), 'SEG'],
          ['SRR_S11_SERVICE', None, (0, -1), 'GRP'],
          ['SRR_S11_GENERAL_RESOURCE', None, (0, -1), 'GRP'],
          ['SRR_S11_LOCATION_RESOURCE', None, (0, -1), 'GRP'],
          ['SRR_S11_PERSONNEL_RESOURCE', None, (0, -1), 'GRP'],
      ),
   ),
  'SRR_S11_SERVICE': (
      'sequence',
