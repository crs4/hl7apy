...
FIELDS = {
    ...
    'CDM_1': ('sequence', DATATYPES_STRUCTS['CWE'], 'CWE', 'PRIMARY_KEY_VALUE_CDM', 'HL70132', -1),
    ...
    'CM1_2': ('sequence', DATATYPES_STRUCTS['CWE'], 'CWE', 'STUDY_PHASE_IDENTIFIER', 'HL79999', -1),
    ...
    'CSP_1': ('sequence', DATATYPES_STRUCTS['CWE'], 'CWE', 'STUDY_PHASE_IDENTIFIER', 'HL79999', -1),
    ...
    'CTI_2': ('sequence', DATATYPES_STRUCTS['CWE'], 'CWE', 'STUDY_PHASE_IDENTIFIER', 'HL79999', -1),
    ...
    'DG1_2': ('leaf', None, 'SI', 'DIAGNOSIS_CODING_METHOD', None, -1),
    'DG1_3': ('sequence', DATATYPES_STRUCTS['CWE'], 'CWE', 'DIAGNOSIS_CODE_DG1', 'HL70051', -1),
    'DG1_4': ('leaf', None, 'SI', 'DIAGNOSIS_DESCRIPTION', None, -1),
    'DG1_5': ('leaf', None, 'DTM', 'DIAGNOSIS_DATE_TIME', None, -1),
    'DG1_6': ('sequence', DATATYPES_STRUCTS['CWE'], 'CWE', 'DIAGNOSIS_TYPE', None, -1),
    'DG1_7': ('sequence', DATATYPES_STRUCTS['CNE'], 'CNE', 'MAJOR_DIAGNOSTIC_CATEGORY', None, -1),
    'DG1_8': ('sequence', DATATYPES_STRUCTS['CNE'], 'CNE', 'DIAGNOSTIC_RELATED_GROUP', None, -1),
    'DG1_9': ('leaf', None, 'ID', 'DRG_APPROVAL_INDICATOR', None, -1),
    'DG1_10': ('sequence', DATATYPES_STRUCTS['CWE'], 'CWE', 'DRG_GROUPER_REVIEW_CODE', None, -1),
    'DG1_11': ('sequence', DATATYPES_STRUCTS['CWE'], 'CWE', 'OUTLIER_TYPE', None, -1),
    'DG1_12': ('leaf', None, 'NM', 'OUTLIER_DAYS', None, -1),
    'DG1_13': ('sequence', DATATYPES_STRUCTS['CP'], 'CP', 'OUTLIER_COST', None, -1),
    'DG1_14': ('leaf', None, 'SI', 'DIAGNOSIS_CODING_METHOD', None, -1),
    ...
    'ECD_4': ('leaf', None, 'ST', 'REQUESTED_COMPLETION_TIME', None, -1),
    ...
    'ERR_1': ('leaf', None, 'ST', 'ERROR_CODE_AND_LOCATION', None, -1),
    ...
    'EVN_1': ('leaf', None, 'ST', 'EVENT_TYPE_CODE', None, -1),
    ...
    'GOL_15': ('leaf', None, 'ST', 'GOAL_REVIEW_INTERVAL', None, -1),
    ...
    'GT1_45': ('sequence', DATATYPES_STRUCTS['XPN'], 'XPN', 'CONTACT_PERSON_S_NAME', 'HL70200', -1),
    ...
    'IN1_38': ('leaf', None, 'ST', 'POLICY_LIMIT_AMOUNT', None, -1),
    'IN1_39': ('leaf', None, 'NM', 'POLICY_LIMIT_DAYS', None, -1),
    'IN1_40': ('leaf', None, 'ST', 'ROOM_RATE_SEMI_PRIVATE', None, -1),
    'IN1_41': ('leaf', None, 'ST', 'ROOM_RATE_PRIVATE', None, -1),
    ...
    'INV_14': ('leaf', None, 'ST', 'TEST_FLUID_IDENTIFIERS', None, -1),
    ...
    'MRG_2': ('lead', None, 'ST', 'PRIOR_ALTERNATE_PATIENT_ID', None, -1),
    ...
    'MSA_5': ('leaf', None, 'NM', 'DELAYED_AKNOWLEDGEMENT_TYPE', None, -1),
    'MSA_6': ('leaf', None, 'NM', 'ERROR_CONDITION', None, -1),
    ...
    'NK1_30': ('sequence', DATATYPES_STRUCTS['XPN'], 'XPN', 'CONTACT_PERSON_S_NAME', 'HL70200', -1),
    ...
    'OBR_6': ('leaf', None, 'ST', 'REQUESTED_DATE_TIME', None, -1),
    ...
    'OBR_14': ('leaf', None, 'ST', 'SPECIMEN_RECEIVED_DATE_TIME', None, -1),
    'OBR_15': ('leaf', None, 'ST', 'SPECIMENT_SOURCE', None, -1),
    ...
    'OBR_27': ('leaf', None, 'ST', 'QUANTITY_TIMING', None, -1),
    'OBR_28': ('sequence', DATATYPES_STRUCTS['XCN'], 'XCN', 'RESULT_COPIES_TO', None, -1),
    'OBR_29': ('sequence', DATATYPES_STRUCTS['EIP'], 'EIP', 'PARENT_RESULT_OBSERVATION_IDENTIFIER', None, -1),
    ...
    'OM7_24': ('sequence', DATATYPES_STRUCTS['CWE'], 'CWE', 'PRIMARY_KEY_VALUE_CDM', 'HL70132', -1),
    ...
    'ORC_7': ('leaf', None, 'ST', 'QUANTITY_TIMING', 'HL70121', -1),
    ...
    'PD1_4': ('leaf', None, 'ST', 'PATIENT_PRIMARY_CARE_PROVIDER_NAME_ID NO', 'HL70204', -1),
    ...
    'PID_2': ('leaf', None, 'ST', 'PATIENT_ID', None, -1),
    ...
    'PID_19': ('leaf', None, 'ST', 'SSN_NUMBER', None, -1),
    'PID_20': ('leaf', None, 'ST', 'DRIVERS_LICENSE_NUMBER', None, -1),
    ...
    'PID_35': ('sequence', DATATYPES_STRUCTS['CWE'], 'CWE', 'SPECIES_CODE', 'HL70446', -1),
    ...
    'PR1_2': ('leaf', None, 'ST', 'PROCEDURE_CODING_METHOD', None, -1),
    ...
    'PR1_8': ('leaf', None, 'ST', 'ANESTHESIOLOGIST', None, -1),
    ...
    'QPD_3': ('leaf', 'varies', 'varies', 'USER_PARAMETERS_IN_SUCCESSIVE_FIELDS', None, -1),
    ...
    'RXA_17': ('sequence', DATATYPES_STRUCTS['CWE'], 'CWE', 'SUBSTANCE_MANUFACTURER_NAME', 'HL70227', -1),
    ...
    'RXD_15': ('sequence', DATATYPES_STRUCTS['CWE'], 'CWE', 'PHARMACY_TREATMENT_SUPPLIER_S_SPECIAL_DISPENSING_INSTRUCTIONS', 'HL79999', -1),
    ...
    'RXD_20': ('sequence', DATATYPES_STRUCTS['CWE'], 'CWE', 'SUBSTANCE_MANUFACTURER_NAME', 'HL70227', -1),
    ...
    'RXE_1': ('leaf', None, 'ST', 'QUANTITY_TIMING', None, -1),
    ...
    'RXE_21': ('sequence', DATATYPES_STRUCTS['CWE'], 'CWE', 'PHARMACY_TREATMENT_SUPPLIER_S_SPECIAL_DISPENSING_INSTRUCTIONS', 'HL79999', -1),
    ...
    'RXG_13': ('sequence', DATATYPES_STRUCTS['CWE'], 'CWE', 'PHARMACY_TREATMENT_SUPPLIER_S_SPECIAL_ADMINISTRATION_INSTRUCTIONS', 'HL79999', -1),
    ...
    'RXG_21': ('sequence', DATATYPES_STRUCTS['CWE'], 'CWE', 'SUBSTANCE_MANUFACTURER_NAME', 'HL70227', -1),
    ...
    'SAC_6': ('leaf', None, 'ST', 'SPECIMEN_SOURCE', None, -1),
    ...
    'SCH_9': ('leaf', None, 'ST', 'APPOINTMENT_DURATION', None, -1),
    ...
    'TCC_3': ('leaf', None, 'ST', 'SPECIMEN_SOURCE', None, -1),
    ...
    'UB1_2': ('leaf', None, 'SY', 'BLOOD_DEDUCTIBLE', None, -1),
    'UB1_3': ('leaf', None, 'ST', 'BLOOD_FURNISHED_PINTS', None, -1),
    'UB1_4': ('leaf', None, 'ST', 'BLOOD_REPLACED_PINTS', None, -1),
    'UB1_5': ('leaf', None, 'ST', 'BLOOD_NOT_REPLACED_PINTS', None, -1),
    'UB1_6': ('leaf', None, 'ST', 'CO_INSURANCE_DAYS', None, -1),
    'UB1_7': ('leaf', None, 'ST', 'CONDITION_CODE', 'HL70043', -1),
    'UB1_8': ('leaf', None, 'ST', 'COVERED_DAYS', None, -1),
    'UB1_9': ('leaf', None, 'ST', 'NON_COVERED_DAYS', None, -1),
    'UB1_10': ('leag', None, 'ST', 'VALUE_AMOUNT_CODE', None, -1),
    'UB1_11': ('leaf', None, 'ST', 'NUMBER_OF_GRACE_DAYS', None, -1),
    'UB1_12': ('leaf', None, 'ST', 'SPECIAL_PROGRAM_INDICATOR', 'HL70348', -1),
    'UB1_13': ('leaf', None, 'ST', 'PSRO_UR_APPROVAL_INDICATOR', 'HL70349', -1),
    'UB1_14': ('leaf', None, 'ST', 'PSRO_UR_APPROVED_STAY_FM', None, -1),
    'UB1_15': ('leaf', None, 'ST', 'PSRO_UR_APPROVED_STAY_TO', None, -1),
    'UB1_16': ('leaf', None, 'ST', 'OCCURRENCE', None, -1),
    'UB1_17': ('leaf', None, 'ST', 'OCCURRENCE_SPAN', 'HL70351', -1),
    'UB1_18': ('leaf', None, 'ST', 'OCCUR_SPAN_START_DATE', None, -1),
    'UB1_19': ('leaf', None, 'ST', 'OCCUR_SPAN_END_DATE', None, -1),
