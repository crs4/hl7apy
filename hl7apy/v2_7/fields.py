...
FIELDS = {
    ...
    'MFA_5': ('sequence', 'varies', 'varies', 'PRIMARY_KEY_VALUE_MFA', 'HL79999', -1),
    ...
    'MFE_4': ('sequence', 'varies', 'varies', 'PRIMARY_KEY_VALUE_MFE', 'HL79999', -1),
    ...
    'OBX_5': ('sequence', 'varies', 'varies', 'OBSERVATION_VALUE', None, -1),
    ...
    'QPD_3': ('sequence', 'varies', 'varies', 'USER_PARAMETERS_IN_SUCCESSIVE_FIELDS', None, -1),
    ...
    'RDT_1': ('sequence', 'varies', 'varies', 'COLUMN_VALUE', None, -1),
