...
GROUPS = {
  ...
  'CQU_I19_RESOURCE_DETAIL': (
      'sequence',
      (
          ['CQU_I19_RESOURCE_OBJECT', None, (0, 1), 'GRP'],
          ['OBX', SEGMENTS['OBX'], (0, -1), 'SEG'],
      ),
   ),
  ...
  'CQU_I19_ROLE_PROBLEM': (
      'sequence',
      (
          ['CQU_I19_ROLE_PROBLEM_OBJECT', None, (0, 1), 'GRP'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
      ),
   ),
  ...
  'CQU_I19_ROLE_GOAL': (
      'sequence',
      (
          ['CQU_I19_ROAL_GOAL_OBJECT', None, (0, 1), 'GRP'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
      ),
   ),
  'CQU_I19_ROAL_GOAL_OBJECT': (
      'sequence',
      (
          ['ROL', SEGMENTS['ROL'], (0, 1), 'SEG'],
          ['PRD', SEGMENTS['PRD'], (0, 1), 'SEG'],
  ...
  'CQU_I19_ROLE_PATHWAY': (
      'sequence',
      (
          ['CQU_I19_ROLE_PATHWAY_OBJECT', None, (0, 1), 'GRP'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
      ),
   ),
