...
FIELDS = {
    ...
    'CDM_2': ('sequence', DATATYPES_STRUCTS['CWE'], 'CWE', 'CHARGE_CODE_ALIAS', None, -1),
    ...
    'FT1_14': ('sequence', DATATYPES_STRUCTS['CWE'], 'CWE', 'INSURANCE_PLAN_ID', 'HL70072', -1),
    ...
    'IN1_2': ('sequence', DATATYPES_STRUCTS['CWE'], 'CWE', 'INSURANCE_PLAN_ID', 'HL70072', -1),
    ...
    'MSA_6': ('sequence', DATATYPES_STRUCTS['CNE'], 'CNE', 'ERROR_CONDITION', 'HL70357', -1),
    ...
    'OM1_31': ('sequence', DATATYPES_STRUCTS['CWE'], 'CWE', 'OBSERVATIONS_REQUIRED_TO_INTERPRET_THE_OBSERVATION', 'HL79999', -1),
    ...
    'OM1_47': ('sequence', DATATYPES_STRUCTS['CWE'], 'CWE', 'MODALITY_OF_IMAGING_MEASUREMENT', 'HL70259', -1),
    ...
    'PID_28': ('sequence', DATATYPES_STRUCTS['CWE'], 'CWE', 'NATIONALITY', 'HL70212', -1),
    ...
    'PSL_17': ('leaf', None, 'IS', 'PRODUCT_SERVICE_CLARIFICATION_CODE_TYPE', 'HL70561', -1),
    ...
    'PYE_3': ('leaf', None, 'IS', 'PAYEE_RELATIONSHIP_TO_INVOICE_PATIENT', 'HL70558', -1),
    ...
    'QRD_9': ('sequence', DATATYPES_STRUCTS['CWE'], 'CWE', 'WHAT_SUBJECT_FILTER', 'HL70048', -1),
    'QRD_10': ('sequence', DATATYPES_STRUCTS['CWE'], 'CWE', 'WHAT_DEPARTMENT_DATA_CODE', None, -1),
    ...
    'STZ_2': ('sequence', DATATYPES_STRUCTS['CWE'], 'CWE', 'STERILIZATION_CYCLE', None, -1),
    ...
    'UB1_10': ('sequence', DATATYPES_STRUCTS['UVC'], 'UVC', 'VALUE_AMOUNT_CODE', None, -1),
    'UB1_11': ('leaf', None, 'NM', 'NUMBER_OF_GRACE_DAYS', None, -1),
    'UB1_12': ('sequence', DATATYPES_STRUCTS['CWE'], 'CWE', 'SPECIAL_PROGRAM_INDICATOR', 'HL70348', -1),
    'UB1_13': ('sequence', DATATYPES_STRUCTS['CWE'], 'CWE', 'PSRO_UR_APPROVAL_INDICATOR', 'HL70349', -1),
    ...
    'UB1_17': ('sequence', DATATYPES_STRUCTS['CWE'], 'CWE', 'OCCURRENCE_SPAN', 'HL70351', -1),
    ...
    'URD_4': ('sequence', DATATYPES_STRUCTS['CWE'], 'CWE', 'R_U_WHAT_SUBJECT_DEFINITION', 'HL70048', -1),
    'URD_5': ('sequence', DATATYPES_STRUCTS['CWE'], 'CWE', 'R_U_WHAT_DEPARTMENT_CODE', None, -1),
