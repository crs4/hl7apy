...
MESSAGES = {
  ...
  'MDM_T02': (
      ...
      (
          ...
          ['TXA', SEGMENTS['TXA'], (1, 1), 'SEG'],
          ['MDM_T02_OBXNTE', GROUPS['MDM_T02_OBXNTE'], (1, -1), 'GRP'],
      ),
   ),
  'MDM_T03': (
      'sequence',
  ...
  'MDM_T04': (
      ...
      (
          ...
          ['TXA', SEGMENTS['TXA'], (1, 1), 'SEG'],
          ['MDM_T04_OBXNTE', GROUPS['MDM_T04_OBXNTE'], (1, -1), 'GRP'],
      ),
   ),
  'MDM_T05': (
      'sequence',
  ...
  'MDM_T06': (
      ...
      (
          ...
          ['TXA', SEGMENTS['TXA'], (1, 1), 'SEG'],
          ['MDM_T06_OBXNTE', GROUPS['MDM_T06_OBXNTE'], (1, -1), 'GRP'],
      ),
   ),
  'MDM_T07': (
      'sequence',
  ...
  'MDM_T08': (
      ...
      (
          ...
          ['TXA', SEGMENTS['TXA'], (1, 1), 'SEG'],
          ['MDM_T08_OBXNTE', GROUPS['MDM_T08_OBXNTE'], (1, -1), 'GRP'],
      ),
   ),
  'MDM_T09': (
      'sequence',
  ...
  'MDM_T10': (
      ...
      (
          ...
          ['TXA', SEGMENTS['TXA'], (1, 1), 'SEG'],
          ['MDM_T10_OBXNTE', GROUPS['MDM_T10_OBXNTE'], (1, -1), 'GRP'],
      ),
   ),
  'MDM_T11': (
      'sequence',
  ...
  'ORF_W02': (
      ...
      (
          ...
          ['QRD', SEGMENTS['QRD'], (1, 1), 'SEG'],
          ['QRF', SEGMENTS['QRF'], (0, 1), 'SEG'],
          ['ORF_W02_QUERY_RESPONSE', GROUPS['ORF_W02_QUERY_RESPONSE'], (1, -1), 'GRP'],
          ['ERR', SEGMENTS['ERR'], (0, -1), 'SEG'],
          ['QAK', SEGMENTS['QAK'], (0, 1), 'SEG'],
          ['DSC', SEGMENTS['DSC'], (0, 1), 'SEG'],
      ),
  ...
  'ORU_W01': (
      ...
      (
          ...
          ['SFT', SEGMENTS['SFT'], (0, -1), 'SEG'],
          ['UAC', SEGMENTS['UAC'], (0, 1), 'SEG'],
          ['ORU_W01_PATIENT_RESULT', GROUPS['ORU_W01_PATIENT_RESULT'], (1, -1), 'GRP'],
          ['DSC', SEGMENTS['DSC'], (0, 1), 'SEG'],
      ),
   ),
  'OSQ_Q06': (
  ...
  'SCN_S37': (
      ...
      (
          ...
          ['SFT', SEGMENTS['SFT'], (0, -1), 'SEG'],
          ['UAC', SEGMENTS['UAC'], (0, 1), 'SEG'],
          ['SCN_S37_ANTI_MICROBIAL_DEVICE_CYCLE_DATA', GROUPS['SCN_S37_ANTI_MICROBIAL_DEVICE_CYCLE_DATA'], (1, -1), 'GRP'],
      ),
   ),
  'SDN_S36': (
      'sequence',
      (
          ...
          ['SFT', SEGMENTS['SFT'], (0, -1), 'SEG'],
          ['UAC', SEGMENTS['UAC'], (0, 1), 'SEG'],
          ['SDN_S36_ANTI_MICROBIAL_DEVICE_DATA', GROUPS['SDN_S36_ANTI_MICROBIAL_DEVICE_DATA'], (1, -1), 'GRP'],
      ),
   ),
  'SDR_S31': (
      'sequence',
  ...
  'SMD_S32': (
      ...
      (
          ...
          ['SFT', SEGMENTS['SFT'], (0, -1), 'SEG'],
          ['UAC', SEGMENTS['UAC'], (0, 1), 'SEG'],
          ['SMD_S32_ANTI_MICROBIAL_DEVICE_CYCLE_DATA', GROUPS['SMD_S32_ANTI_MICROBIAL_DEVICE_CYCLE_DATA'], (1, -1), 'GRP'],
      ),
   ),
  'SPQ_Q08': (
      'sequence',
