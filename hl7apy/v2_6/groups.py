...
GROUPS = {
  ...
  'MFR_M05_MF_QUERY': (
      ...
      (
          ...
          ['LCH', SEGMENTS['LCH'], (0, -1), 'SEG'],
          ['LRL', SEGMENTS['LRL'], (0, -1), 'SEG'],
          ['MFR_M05_MF_LOCATION', None, (1, -1), 'GRP'],
      ),
   ),
  'MFR_M05_MF_LOCATION': (
      'sequence',
  ...
  'MFR_M06_MF_QUERY': (
      ...
      (
          ['MFE', SEGMENTS['MFE'], (1, 1), 'SEG'],
          ['CM0', SEGMENTS['CM0'], (1, 1), 'SEG'],
          ['MFR_M06_MF_CLINICAL_STUDY', None, (0, -1), 'GRP'],
      ),
   ),
  'MFR_M06_MF_CLINICAL_STUDY': (
      'sequence',
      (
          ['CM1', SEGMENTS['CM1'], (1, 1), 'SEG'],
          ['CM2', SEGMENTS['CM2'], (0, -1), 'SEG'],
  ...
  'OML_O35_ORDER_PRIOR': (
      ...
      (
          ...
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['ROL', SEGMENTS['ROL'], (0, -1), 'SEG'],
          ['OML_O35_TIMING_PRIOR', None, (1, 1), 'GRP'],
  ...
  'ORF_W02_QUERY_RESPONSE': (
      'sequence',
      (
          ['ORF_W02_PATIENT', None, (0, 1), 'GRP'],
          ['ORF_W02_ORDER', None, (1, -1), 'GRP'],
      ),
   ),
  'ORF_W02_PATIENT': (
      'sequence',
  ...
  'ORF_W02_ORDER': (
      ...
      (
          ...
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['ROL', SEGMENTS['ROL'], (0, -1), 'SEG'],
          ['ORF_W02_TIMING_QTY', None, (0, -1), 'GRP'],
          ['CTD', SEGMENTS['CTD'], (0, 1), 'SEG'],
          ['ORF_W02_OBSERVATION', None, (1, -1), 'GRP'],
          ['CTI', SEGMENTS['CTI'], (0, -1), 'SEG'],
      ),
   ),
  'ORF_W02_TIMING_QTY': (
  ...
  'ORM_O01_ORDER_DETAIL': (
      'sequence',
      (
          ['ORM_O01_ORDER_DETAIL_SEGMENT', None, (1, 1), 'GRP'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['CTD', SEGMENTS['CTD'], (0, 1), 'SEG'],
          ['DG1', SEGMENTS['DG1'], (0, -1), 'SEG'],
  ...
  'ORR_O02_ORDER': (
      ...
      (
          ['ORC', SEGMENTS['ORC'], (1, 1), 'SEG'],
          ['ORR_O02_ORDER_DETAIL_SEGMENT', None, (0, 1), 'GRP'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['CTI', SEGMENTS['CTI'], (0, -1), 'SEG'],
      ),
   ),
  'ORR_O02_ORDER_DETAIL_SEGMENT': (
      'sequence',
      (
          ['OBR', SEGMENTS['OBR'], (0, 1), 'SEG'],
          ['RQD', SEGMENTS['RQD'], (0, 1), 'SEG'],
  ...
  'ORU_W01_PATIENT_RESULT': (
      'sequence',
      (
          ['ORU_W01_PATIENT', None, (0, 1), 'GRP'],
          ['ORU_W01_ORDER_OBSERVATION', None, (1, -1), 'GRP'],
      ),
   ),
  'ORU_W01_PATIENT': (
      'sequence',
  ...
  'ORU_W01_ORDER_OBSERVATION': (
      ...
      (
          ...
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['ROL', SEGMENTS['ROL'], (0, -1), 'SEG'],
          ['ORU_W01_TIMING_QTY', None, (0, -1), 'GRP'],
          ['CTD', SEGMENTS['CTD'], (0, 1), 'SEG'],
          ['ORU_W01_OBSERVATION', None, (0, -1), 'GRP'],
          ['FT1', SEGMENTS['FT1'], (0, -1), 'SEG'],
          ['CTI', SEGMENTS['CTI'], (0, -1), 'SEG'],
          ['ORU_W01_SPECIMEN', None, (0, -1), 'GRP'],
      ),
   ),
  'ORU_W01_TIMING_QTY': (
      'sequence',
  ...
  'OSR_Q06_ORDER': (
      ...
      (
          ...
          ['OSR_Q06_ORDER_DETAIL_SEGMENT', None, (0, 1), 'GRP'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['CTI', SEGMENTS['CTI'], (0, -1), 'SEG'],
      ),
   ),
  ...
  'PGL_PC6_ORDER_DETAIL': (
      'sequence',
      (
          ['PGL_PC6_ORDER_DETAIL_SEGMENT', None, (1, 1), 'GRP'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PGL_PC6_ORDER_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'PGL_PC6_ORDER_DETAIL_SEGMENT': (
      'sequence',
      (
          ['OBR', SEGMENTS['OBR'], (0, 1), 'SEG'],
          ['RQD', SEGMENTS['RQD'], (0, 1), 'SEG'],
  ...
  'PGL_PC7_ORDER_DETAIL': (
      'sequence',
      (
          ['PGL_PC7_ORDER_DETAIL_SEGMENT', None, (1, 1), 'GRP'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PGL_PC7_ORDER_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'PGL_PC7_ORDER_DETAIL_SEGMENT': (
      'sequence',
      (
          ['OBR', SEGMENTS['OBR'], (0, 1), 'SEG'],
          ['RQD', SEGMENTS['RQD'], (0, 1), 'SEG'],
  ...
  'PGL_PC8_ORDER_DETAIL': (
      'sequence',
      (
          ['PGL_PC8_ORDER_DETAIL_SEGMENT', None, (1, 1), 'GRP'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PGL_PC8_ORDER_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'PGL_PC8_ORDER_DETAIL_SEGMENT': (
      'sequence',
      (
          ['OBR', SEGMENTS['OBR'], (0, 1), 'SEG'],
          ['RQD', SEGMENTS['RQD'], (0, 1), 'SEG'],
  ...
  'PPG_PCG_ORDER_DETAIL': (
      'sequence',
      (
          ['PPG_PCG_ORDER_DETAIL_SEGMENT', None, (1, 1), 'GRP'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PPG_PCG_ORDER_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'PPG_PCG_ORDER_DETAIL_SEGMENT': (
      'sequence',
      (
          ['OBR', SEGMENTS['OBR'], (0, 1), 'SEG'],
          ['RQD', SEGMENTS['RQD'], (0, 1), 'SEG'],
  ...
  'PPG_PCH_ORDER_DETAIL': (
      'sequence',
      (
          ['PPG_PCH_ORDER_DETAIL_SEGMENT', None, (1, 1), 'GRP'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PPG_PCH_ORDER_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'PPG_PCH_ORDER_DETAIL_SEGMENT': (
      'sequence',
      (
          ['OBR', SEGMENTS['OBR'], (0, 1), 'SEG'],
          ['RQD', SEGMENTS['RQD'], (0, 1), 'SEG'],
  ...
  'PPG_PCJ_ORDER_DETAIL': (
      'sequence',
      (
          ['PPG_PCJ_ORDER_DETAIL_SEGMENT', None, (1, 1), 'GRP'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PPG_PCJ_ORDER_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'PPG_PCJ_ORDER_DETAIL_SEGMENT': (
      'sequence',
      (
          ['OBR', SEGMENTS['OBR'], (0, 1), 'SEG'],
          ['RQD', SEGMENTS['RQD'], (0, 1), 'SEG'],
  ...
  'PPP_PCB_ORDER_DETAIL': (
      'sequence',
      (
          ['PPP_PCB_ORDER_DETAIL_SEGMENT', None, (1, 1), 'GRP'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PPP_PCB_ORDER_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'PPP_PCB_ORDER_DETAIL_SEGMENT': (
      'sequence',
      (
          ['OBR', SEGMENTS['OBR'], (0, 1), 'SEG'],
          ['RQD', SEGMENTS['RQD'], (0, 1), 'SEG'],
  ...
  'PPP_PCC_ORDER_DETAIL': (
      'sequence',
      (
          ['PPP_PCC_ORDER_DETAIL_SEGMENT', None, (1, 1), 'GRP'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PPP_PCC_ORDER_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'PPP_PCC_ORDER_DETAIL_SEGMENT': (
      'sequence',
      (
          ['OBR', SEGMENTS['OBR'], (0, 1), 'SEG'],
          ['RQD', SEGMENTS['RQD'], (0, 1), 'SEG'],
  ...
  'PPP_PCD_ORDER_DETAIL': (
      'sequence',
      (
          ['PPP_PCD_ORDER_DETAIL_SEGMENT', None, (1, 1), 'GRP'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PPP_PCD_ORDER_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'PPP_PCD_ORDER_DETAIL_SEGMENT': (
      'sequence',
      (
          ['OBR', SEGMENTS['OBR'], (0, 1), 'SEG'],
          ['RQD', SEGMENTS['RQD'], (0, 1), 'SEG'],
  ...
  'PPR_PC1_ORDER_DETAIL': (
      'sequence',
      (
          ['PPR_PC1_ORDER_DETAIL_SEGMENT', None, (1, 1), 'GRP'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PPR_PC1_ORDER_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'PPR_PC1_ORDER_DETAIL_SEGMENT': (
      'sequence',
      (
          ['OBR', SEGMENTS['OBR'], (0, 1), 'SEG'],
          ['RQD', SEGMENTS['RQD'], (0, 1), 'SEG'],
  ...
  'PPR_PC2_ORDER_DETAIL': (
      'sequence',
      (
          ['PPR_PC2_ORDER_DETAIL_SEGMENT', None, (1, 1), 'GRP'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PPR_PC2_ORDER_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'PPR_PC2_ORDER_DETAIL_SEGMENT': (
      'sequence',
      (
          ['OBR', SEGMENTS['OBR'], (0, 1), 'SEG'],
          ['RQD', SEGMENTS['RQD'], (0, 1), 'SEG'],
  ...
  'PPR_PC3_ORDER_DETAIL': (
      'sequence',
      (
          ['PPR_PC3_ORDER_DETAIL_SEGMENT', None, (1, 1), 'GRP'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PPR_PC3_ORDER_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'PPR_PC3_ORDER_DETAIL_SEGMENT': (
      'sequence',
      (
          ['OBR', SEGMENTS['OBR'], (0, 1), 'SEG'],
          ['RQD', SEGMENTS['RQD'], (0, 1), 'SEG'],
  ...
  'PPT_PCL_ORDER_DETAIL': (
      'sequence',
      (
          ['PPT_PCL_ORDER_DETAIL_SEGMENT', None, (1, 1), 'GRP'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PPT_PCL_ORDER_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'PPT_PCL_ORDER_DETAIL_SEGMENT': (
      'sequence',
      (
          ['OBR', SEGMENTS['OBR'], (0, 1), 'SEG'],
          ['RQD', SEGMENTS['RQD'], (0, 1), 'SEG'],
  ...
  'PPV_PCA_ORDER_DETAIL': (
      'sequence',
      (
          ['PPV_PCA_ORDER_DETAIL_SEGMENT', None, (1, 1), 'GRP'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PPV_PCA_ORDER_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'PPV_PCA_ORDER_DETAIL_SEGMENT': (
      'sequence',
      (
          ['OBR', SEGMENTS['OBR'], (0, 1), 'SEG'],
          ['RQD', SEGMENTS['RQD'], (0, 1), 'SEG'],
  ...
  'PRR_PC5_ORDER_DETAIL': (
      'sequence',
      (
          ['PRR_PC5_ORDER_DETAIL_SEGMENT', None, (1, 1), 'GRP'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PRR_PC5_ORDER_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'PRR_PC5_ORDER_DETAIL_SEGMENT': (
      'sequence',
      (
          ['OBR', SEGMENTS['OBR'], (0, 1), 'SEG'],
          ['RQD', SEGMENTS['RQD'], (0, 1), 'SEG'],
  ...
  'PTR_PCF_ORDER_DETAIL': (
      'sequence',
      (
          ['PTR_PCF_ORDER_DETAIL_SEGMENT', None, (1, 1), 'GRP'],
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['VAR', SEGMENTS['VAR'], (0, -1), 'SEG'],
          ['PTR_PCF_ORDER_OBSERVATION', None, (0, -1), 'GRP'],
      ),
   ),
  'PTR_PCF_ORDER_DETAIL_SEGMENT': (
      'sequence',
      (
          ['OBR', SEGMENTS['OBR'], (0, 1), 'SEG'],
          ['RQD', SEGMENTS['RQD'], (0, 1), 'SEG'],
  ...
  'RDE_O25_ORDER_DETAIL': (
      ...
      (
          ...
          ['NTE', SEGMENTS['NTE'], (0, -1), 'SEG'],
          ['RXR', SEGMENTS['RXR'], (1, -1), 'SEG'],
          ['RDE_O25_COMPONENTS', None, (0, -1), 'GRP'],
      ),
   ),
  'RDE_O25_COMPONENTS': (
      'sequence',
  ...
  'REF_I13_PROCEDURE': (
      ...
      (
          ['PR1', SEGMENTS['PR1'], (1, 1), 'SEG'],
          ['REF_I13_AUTHORIZATION_CONTACT', None, (0, 1), 'GRP'],
      ),
   ),
  'REF_I13_AUTHORIZATION_CONTACT': (
      'sequence',
  ...
  'REF_I14_PROCEDURE': (
      ...
      (
          ['PR1', SEGMENTS['PR1'], (1, 1), 'SEG'],
          ['REF_I14_AUTHORIZATION_CONTACT', None, (0, 1), 'GRP'],
      ),
   ),
  'REF_I14_AUTHORIZATION_CONTACT': (
      'sequence',
  ...
  'REF_I15_PROCEDURE': (
      ...
      (
          ['PR1', SEGMENTS['PR1'], (1, 1), 'SEG'],
          ['REF_I15_AUTHORIZATION_CONTACT', None, (0, 1), 'GRP'],
      ),
   ),
  'REF_I15_AUTHORIZATION_CONTACT': (
      'sequence',
  ...
  'RQA_I09_PROCEDURE': (
      ...
      (
          ['PR1', SEGMENTS['PR1'], (1, 1), 'SEG'],
          ['RQA_I09_AUTHORIZATION', None, (0, 1), 'GRP'],
      ),
   ),
  'RQA_I09_AUTHORIZATION': (
      'sequence',
  ...
  'RQA_I10_PROCEDURE': (
      ...
      (
          ['PR1', SEGMENTS['PR1'], (1, 1), 'SEG'],
          ['RQA_I10_AUTHORIZATION', None, (0, 1), 'GRP'],
      ),
   ),
  'RQA_I10_AUTHORIZATION': (
      'sequence',
  ...
  'RQA_I11_PROCEDURE': (
      ...
      (
          ['PR1', SEGMENTS['PR1'], (1, 1), 'SEG'],
          ['RQA_I11_AUTHORIZATION', None, (0, 1), 'GRP'],
      ),
   ),
  'RQA_I11_AUTHORIZATION': (
      'sequence',
