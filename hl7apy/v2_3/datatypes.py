...
DATATYPES = {
    ...
    'CM_MDV_1': ['laef', None, 'NM', 'MINIMUM_VALUE', None, -1],
    'CM_MDV_2': ['laef', None, 'NM', 'MAXIMUM_VALUE', None, -1],
    ...
    'CM_NDL_1': ['sequence', None, 'CN', 'NAME', None, -1],
    ...
    'CM_RFR_1': ['sequence', None, 'CM_RANGE', 'REFERENCE_RANGE', None, -1],
    'CM_RFR_2': ['leaf', None, 'IS', 'SEX', None, -1],
    'CM_RFR_3': ['sequence', None, 'CM_RANGE', 'AGE_RANGE', None, -1],
    'CM_RFR_4': ['sequence', None, 'CM_RANGE', 'AGE_GESTATION', None, -1],
