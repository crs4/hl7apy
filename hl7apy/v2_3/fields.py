...
FIELDS = {
    ...
    'IN3_20': ('sequence', DATATYPES_STRUCTS['PCF'], 'PCF', 'PRE_CERTIFICATION_REQUIRED_WINDOW', None, -1),
    ...
    'OM2_7': ('sequence', DATATYPES_STRUCTS['RANGE'], 'RANGE', 'CRITICAL_RANGE_FOR_ORDINAL_CONTINUOUS_OBS', None, -1),
    'OM2_8': ('sequence', DATATYPES_STRUCTS['ABSRANGE'], 'ABSRANGE', 'ABSOLUTE_RANGE_FOR_ORDINAL_CONTINUOUS_OBS', None, -1),
    ...
    'PRA_5': ('sequence', DATATYPES_STRUCTS['SPD'], 'SPD', 'SPECIALTY', 'HL70187', -1),
    ...
    'RDT_1': ('sequence', DATATYPES_STRUCTS['*'], '*', 'COLUMN_VALUE', None, -1),
    ...
    'RXD_13': ('sequence', DATATYPES_STRUCTS['LA1'], 'LA1', 'DISPENSE_TO_LOCATION', None, -1),
    ...
    'RXG_11': ('sequence', DATATYPES_STRUCTS['LA1'], 'LA1', 'DISPENSE_TO_LOCATION', None, -1),
