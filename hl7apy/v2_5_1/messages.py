...
MESSAGES = {
  ...
  'ADT_A40': (
      ...
      (
          ...
          ['SFT', SEGMENTS['SFT'], (0, -1), 'SEG'],
          ['EVN', SEGMENTS['EVN'], (1, 1), 'SEG'],
          ['ADT_A40_PATIENT_ID', GROUPS['ADT_A40_PATIENT_ID'], (1, -1), 'GRP'],
      ),
   ),
  'ADT_A41': (
      'sequence',
      (
          ...
          ['SFT', SEGMENTS['SFT'], (0, -1), 'SEG'],
          ['EVN', SEGMENTS['EVN'], (1, 1), 'SEG'],
          ['ADT_A41_PATIENT_ID', GROUPS['ADT_A41_PATIENT_ID'], (1, -1), 'GRP'],
      ),
   ),
  'ADT_A42': (
      'sequence',
      (
          ...
          ['SFT', SEGMENTS['SFT'], (0, -1), 'SEG'],
          ['EVN', SEGMENTS['EVN'], (1, 1), 'SEG'],
          ['ADT_A42_PATIENT_ID', GROUPS['ADT_A42_PATIENT_ID'], (1, -1), 'GRP'],
      ),
   ),
  'ADT_A43': (
      'sequence',
  ...
  'ADT_A44': (
      ...
      (
          ...
          ['SFT', SEGMENTS['SFT'], (0, -1), 'SEG'],
          ['EVN', SEGMENTS['EVN'], (1, 1), 'SEG'],
          ['ADT_A44_PATIENT_ID', GROUPS['ADT_A44_PATIENT_ID'], (1, -1), 'GRP'],
      ),
   ),
  'ADT_A45': (
      'sequence',
  ...
  'MFK_M02': (
      ...
      (
          ...
          ['MFI', SEGMENTS['MFI'], (1, 1), 'SEG'],
          ['MFA', SEGMENTS['MFA'], (0, -1), 'SEG'],
          ['MFK_M02_MF_STAFF', GROUPS['MFK_M02_MF_STAFF'], (1, -1), 'GRP'],
      ),
   ),
  'MFK_M04': (
      'sequence',
  ...
  'ORF_W02': (
      ...
      (
          ...
          ['QRD', SEGMENTS['QRD'], (1, 1), 'SEG'],
          ['QRF', SEGMENTS['QRF'], (0, 1), 'SEG'],
          ['ORF_W02_RESPONSE', GROUPS['ORF_W02_RESPONSE'], (1, -1), 'GRP'],
          ['ERR', SEGMENTS['ERR'], (0, -1), 'SEG'],
          ['QAK', SEGMENTS['QAK'], (0, 1), 'SEG'],
          ['DSC', SEGMENTS['DSC'], (0, 1), 'SEG'],
      ),
  ...
  'RPA_I09': (
      ...
      (
          ...
          ['MSA', SEGMENTS['MSA'], (1, 1), 'SEG'],
          ['RF1', SEGMENTS['RF1'], (0, 1), 'SEG'],
          ['RPA_I09_AUTHORIZATION', GROUPS['RPA_I09_AUTHORIZATION'], (0, 1), 'GRP'],
  ...
  'RPA_I10': (
      ...
      (
          ...
          ['MSA', SEGMENTS['MSA'], (1, 1), 'SEG'],
          ['RF1', SEGMENTS['RF1'], (0, 1), 'SEG'],
          ['RPA_I10_AUTHORIZATION', GROUPS['RPA_I10_AUTHORIZATION'], (0, 1), 'GRP'],
  ...
  'RPA_I11': (
      ...
      (
          ...
          ['MSA', SEGMENTS['MSA'], (1, 1), 'SEG'],
          ['RF1', SEGMENTS['RF1'], (0, 1), 'SEG'],
          ['RPA_I11_AUTHORIZATION', GROUPS['RPA_I11_AUTHORIZATION'], (0, 1), 'GRP'],
