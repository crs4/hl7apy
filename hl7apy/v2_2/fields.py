...
FIELDS = {
    ...
    'FT1_16': ('sequence', DATATYPES_STRUCTS['CM_INTERNAL_LOCATION'], 'CM_INTERNAL_LOCATION', 'ASSIGNED_PATIENT_LOCATION', 'HL70079', -1),
    ...
    'MRG_3': ('sequence', DATATYPES_STRUCTS['CK_ACCOUNT_NO'], 'CK_ACCOUNT_NO', 'PRIOR_PATIENT_ACCOUNT_NUMBER', None, -1),
    ...
    'NPU_1': ('sequence', DATATYPES_STRUCTS['CM_INTERNAL_LOCATION'], 'CM_INTERNAL_LOCATION', 'BED_LOCATION', 'HL70079', -1),
    ...
    'OM2_7': ('sequence', DATATYPES_STRUCTS['CM_RFR'], 'CM_RFR', 'REFERENCE_NORMAL_RANGE_ORDINAL_CONTINUOUS_OBSERVATIONS', None, -1),
    'OM2_8': ('sequence', DATATYPES_STRUCTS['CM_RANGE'], 'CM_RANGE', 'CRITICAL_RANGE_FOR_ORDINAL_AND_CONTINUOUS_OBSERVATIONS', None, -1),
    'OM2_9': ('sequence', DATATYPES_STRUCTS['CM_ABS_RANGE'], 'CM_ABS_RANGE', 'ABSOLUTE_RANGE_FOR_ORDINAL_AND_CONTINUOUS_OBSERVATIONS', None, -1),
    ...
    'PID_20': ('sequence', DATATYPES_STRUCTS['CM_LICENSE_NO'], 'CM_LICENSE_NO', 'DRIVER_S_LICENSE_NUMBER_PATIENT', None, -1),
    ...
    'PR1_12': ('sequence', DATATYPES_STRUCTS['CM_PRACTITIONER'], 'CM_PRACTITIONER', 'PROCEDURE_PRACTITIONER', 'HL70010', -1),
    ...
    'PV1_3': ('sequence', DATATYPES_STRUCTS['CM_INTERNAL_LOCATION'], 'CM_INTERNAL_LOCATION', 'ASSIGNED_PATIENT_LOCATION', 'HL70079', -1),
    'PV1_4': ('leaf', None, 'ID', 'ADMISSION_TYPE', 'HL70007', -1),
    'PV1_5': ('leaf', None, 'ST', 'PREADMIT_NUMBER', None, -1),
    'PV1_6': ('sequence', DATATYPES_STRUCTS['CM_INTERNAL_LOCATION'], 'CM_INTERNAL_LOCATION', 'PRIOR_PATIENT_LOCATION', None, -1),
    ...
    'PV1_11': ('sequence', DATATYPES_STRUCTS['CM_INTERNAL_LOCATION'], 'CM_INTERNAL_LOCATION', 'TEMPORARY_LOCATION', 'HL70079', -1),
    ...
    'PV1_42': ('sequence', DATATYPES_STRUCTS['CM_INTERNAL_LOCATION'], 'CM_INTERNAL_LOCATION', 'PENDING_LOCATION', None, -1),
    'PV1_43': ('sequence', DATATYPES_STRUCTS['CM_INTERNAL_LOCATION'], 'CM_INTERNAL_LOCATION', 'PRIOR_TEMPORARY_LOCATION', None, -1),
    ...
    'PV2_1': ('sequence', DATATYPES_STRUCTS['CM_INTERNAL_LOCATION'], 'CM_INTERNAL_LOCATION', 'PRIOR_PENDING_LOCATION', None, -1),
