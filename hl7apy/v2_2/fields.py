...
FIELDS = {
    ...
    'BLG_3': ('sequence', DATATYPES_STRUCTS['ACCOUNTNO'], 'ACCOUNTNO', 'ACCOUNT_ID', None, -1),
    'BTS_1': ('leaf', None, 'ST', 'BATCH_MESSAGE_COUNT', None, -1),
    'BTS_2': ('leaf', None, 'ST', 'BATCH_COMMENT', None, -1),
    'BTS_3': ('sequence', DATATYPES_STRUCTS['BATCHTOTAL'], 'BATCHTOTAL', 'BATCH_TOTALS', None, -1),
    ...
    'DG1_16': ('sequence', DATATYPES_STRUCTS['PERSON'], 'PERSON', 'DIAGNOSING_CLINICIAN', None, -1),
    ...
    'ERR_1': ('sequence', DATATYPES_STRUCTS['ELD'], 'ELD', 'ERROR_CODE_AND_LOCATION', 'HL70060', -1),
    ...
    'FT1_16': ('sequence', DATATYPES_STRUCTS['INTERNALLOCATION'], 'INTERNALLOCATION', 'ASSIGNED_PATIENT_LOCATION', 'HL70079', -1),
    ...
    'FT1_20': ('sequence', DATATYPES_STRUCTS['PERSON'], 'PERSON', 'PERFORMED_BY_CODE', 'HL70084', -1),
    'FT1_21': ('sequence', DATATYPES_STRUCTS['PERSON'], 'PERSON', 'ORDERED_BY_CODE', None, -1),
    'FT1_22': ('leaf', None, 'NM', 'UNIT_COST', None, -1),
    'FT1_23': ('sequence', DATATYPES_STRUCTS['FILLER'], 'FILLER', 'FILLER_ORDER_NUMBER', None, -1),
    ...
    'IN1_30': ('sequence', DATATYPES_STRUCTS['PERSON'], 'PERSON', 'VERIFICATION_BY', None, -1),
    ...
    'IN2_3': ('sequence', DATATYPES_STRUCTS['PERSON'], 'PERSON', 'INSURED_S_EMPLOYER_NAME', None, -1),
    ...
    'IN3_3': ('sequence', DATATYPES_STRUCTS['PERSON'], 'PERSON', 'CERTIFIED_BY', None, -1),
    'IN3_4': ('leaf', None, 'ID', 'CERTIFICATION_REQUIRED', 'HL70136', -1),
    'IN3_5': ('sequence', DATATYPES_STRUCTS['PEN'], 'PEN', 'PENALTY', 'HL70148', -1),
    ...
    'IN3_8': ('sequence', DATATYPES_STRUCTS['PERSON'], 'PERSON', 'OPERATOR', None, -1),
    ...
    'IN3_14': ('sequence', DATATYPES_STRUCTS['PERSON'], 'PERSON', 'PHYSICIAN_REVIEWER', None, -1),
    ...
    'IN3_20': ('sequence', DATATYPES_STRUCTS['PCF'], 'PCF', 'PRE_CERTIFICATION_REQUIRED_WINDOW', 'HL70150', -1),
    ...
    'IN3_25': ('sequence', DATATYPES_STRUCTS['PERSON'], 'PERSON', 'SECOND_OPINION_PRACTITIONER', None, -1),
    ...
    'MRG_1': ('sequence', DATATYPES_STRUCTS['PATID'], 'PATID', 'PRIOR_PATIENT_ID_INTERNAL', None, -1),
    'MRG_2': ('sequence', DATATYPES_STRUCTS['PATID'], 'PATID', 'PRIOR_ALTERNATE_PATIENT_ID', None, -1),
    'MRG_3': ('sequence', DATATYPES_STRUCTS['ACCOUNTNO'], 'ACCOUNTNO', 'PRIOR_PATIENT_ACCOUNT_NUMBER', None, -1),
    'MRG_4': ('sequence', DATATYPES_STRUCTS['PATID'], 'PATID', 'PRIOR_PATIENT_ID_EXTERNAL', None, -1),
    ...
    'NK1_11': ('sequence', DATATYPES_STRUCTS['JOBCODE'], 'JOBCODE', 'NEXT_OF_KIN_JOB_CODE_CLASS', None, -1),
    'NK1_12': ('leaf', None, 'ST', 'NEXT_OF_KIN_EMPLOYEE_NUMBER', None, -1),
    'NK1_13': ('leaf', None, 'ST', 'ORGANIZATION_NAME', None, -1),
    'NPU_1': ('sequence', DATATYPES_STRUCTS['INTERNALLOCATION'], 'INTERNALLOCATION', 'BED_LOCATION', 'HL70079', -1),
    ...
    'OBR_2': ('sequence', DATATYPES_STRUCTS['PLACER'], 'PLACER', 'PLACER_ORDER_NUMBER', None, -1),
    'OBR_3': ('sequence', DATATYPES_STRUCTS['FILLER'], 'FILLER', 'FILLER_ORDER_NUMBER', None, -1),
    ...
    'OBR_9': ('sequence', DATATYPES_STRUCTS['QUANTITY'], 'QUANTITY', 'COLLECTION_VOLUME', None, -1),
    'OBR_10': ('sequence', DATATYPES_STRUCTS['PERSON'], 'PERSON', 'COLLECTOR_IDENTIFIER', None, -1),
    ...
    'OBR_16': ('sequence', DATATYPES_STRUCTS['PERSON'], 'PERSON', 'ORDERING_PROVIDER', None, -1),
    ...
    'OBR_26': ('sequence', DATATYPES_STRUCTS['CM'], 'CM', 'PARENT_RESULT', None, -1),
    'OBR_27': ('sequence', DATATYPES_STRUCTS['TQ'], 'TQ', 'QUANTITY_TIMING', None, -1),
    'OBR_28': ('sequence', DATATYPES_STRUCTS['PERSON'], 'PERSON', 'RESULT_COPIES_TO', None, -1),
    'OBR_29': ('sequence', DATATYPES_STRUCTS['EIP'], 'EIP', 'PARENT_NUMBER', None, -1),
    ...
    'OBX_5': ('sequence', DATATYPES_STRUCTS['*'], '*', 'OBSERVATION_VALUE', None, -1),
    ...
    'OBX_16': ('sequence', DATATYPES_STRUCTS['PHYSICIAN'], 'PHYSICIAN', 'RESPONSIBLE_OBSERVER', None, -1),
    ...
    'OM1_14': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'IDENTITY_OF_INSTRUMENT_USED_TO_PERFORM_THIS_STUDY', None, -1),
    ...
    'OM1_22': ('sequence', DATATYPES_STRUCTS['TS'], 'TS', 'DATE_TIME_STAMP_FOR_ANY_CHANGE_IN_DEFINITION_FOR_OBS', None, -1),
    ...
    'OM1_28': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'OUTSIDE_SITE_S_WHERE_OBSERVATION_MAY_BE_PERFORMED', None, -1),
    ...
    'OM1_32': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'OBSERVATIONS_REQUIRED_TO_INTERPRET_THE_OBSERVATION', None, -1),
    ...
    'OM2_7': ('sequence', DATATYPES_STRUCTS['RFR'], 'RFR', 'REFERENCE_NORMAL_RANGE_ORDINAL_CONTINUOUS_OBSERVATIONS', None, -1),
    'OM2_8': ('sequence', DATATYPES_STRUCTS['RANGE'], 'RANGE', 'CRITICAL_RANGE_FOR_ORDINAL_AND_CONTINUOUS_OBSERVATIONS', None, -1),
    'OM2_9': ('sequence', DATATYPES_STRUCTS['ABSRANGE'], 'ABSRANGE', 'ABSOLUTE_RANGE_FOR_ORDINAL_AND_CONTINUOUS_OBSERVATIONS', None, -1),
    'OM2_10': ('sequence', DATATYPES_STRUCTS['DLT'], 'DLT', 'DELTA_CHECK_CRITERIA', None, -1),
    ...
    'OM4_11': ('sequence', DATATYPES_STRUCTS['QUANTITY'], 'QUANTITY', 'NORMAL_COLLECTION_VOLUME', None, -1),
    ...
    'OM5_3': ('sequence', DATATYPES_STRUCTS['CE'], 'CE', 'TESTS_OBSERVATIONS_INCLUDED_WITHIN_AN_ORDERED_TEST_BATTERY', None, -1),
    ...
    'ORC_2': ('sequence', DATATYPES_STRUCTS['PLACER'], 'PLACER', 'PLACER_ORDER_NUMBER', None, -1),
    'ORC_3': ('sequence', DATATYPES_STRUCTS['FILLER'], 'FILLER', 'FILLER_ORDER_NUMBER', None, -1),
    'ORC_4': ('sequence', DATATYPES_STRUCTS['GROUPID'], 'GROUPID', 'PLACER_GROUP_NUMBER', None, -1),
    ...
    'ORC_10': ('sequence', DATATYPES_STRUCTS['PERSON'], 'PERSON', 'ENTERED_BY', None, -1),
    'ORC_11': ('sequence', DATATYPES_STRUCTS['PERSON'], 'PERSON', 'VERIFIED_BY', None, -1),
    'ORC_12': ('sequence', DATATYPES_STRUCTS['PERSON'], 'PERSON', 'ORDERING_PROVIDER', None, -1),
    'ORC_13': ('sequence', DATATYPES_STRUCTS['CM'], 'CM', 'ENTERER_S_LOCATION', None, -1),
    ...
    'ORC_19': ('sequence', DATATYPES_STRUCTS['PERSON'], 'PERSON', 'ACTION_BY', None, -1),
    'PID_1': ('leaf', None, 'SI', 'SET_ID_PATIENT_ID', None, -1),
    'PID_2': ('sequence', DATATYPES_STRUCTS['PATID'], 'PATID', 'PATIENT_ID_EXTERNAL_ID', None, -1),
    'PID_3': ('sequence', DATATYPES_STRUCTS['PATID'], 'PATID', 'PATIENT_ID_INTERNAL_ID', None, -1),
    ...
    'PID_18': ('sequence', DATATYPES_STRUCTS['PATID'], 'PATID', 'PATIENT_ACCOUNT_NUMBER', None, -1),
    'PID_19': ('leaf', None, 'ST', 'SOCIAL_SECURITY_NUMBER_PATIENT', None, -1),
    'PID_20': ('sequence', DATATYPES_STRUCTS['LICENSENO'], 'LICENSENO', 'DRIVER_S_LICENSE_NUMBER_PATIENT', None, -1),
    'PID_21': ('sequence', DATATYPES_STRUCTS['PATID'], 'PATID', 'MOTHER_S_IDENTIFIER', None, -1),
    ...
    'PR1_8': ('sequence', DATATYPES_STRUCTS['PERSON'], 'PERSON', 'ANESTHESIOLOGIST', 'HL70010', -1),
    'PR1_9': ('leaf', None, 'ID', 'ANESTHESIA_CODE', 'HL70019', -1),
    'PR1_10': ('leaf', None, 'NM', 'ANESTHESIA_MINUTES', None, -1),
    'PR1_11': ('sequence', DATATYPES_STRUCTS['PERSON'], 'PERSON', 'SURGEON', 'HL70010', -1),
    'PR1_12': ('sequence', DATATYPES_STRUCTS['PRACTITIONER'], 'PRACTITIONER', 'PROCEDURE_PRACTITIONER', 'HL70010', -1),
    ...
    'PRA_5': ('sequence', DATATYPES_STRUCTS['SPD'], 'SPD', 'SPECIALTY', None, -1),
    'PRA_6': ('sequence', DATATYPES_STRUCTS['PLN'], 'PLN', 'PRACTITIONER_ID_NUMBERS', None, -1),
    ...
    'PV1_3': ('sequence', DATATYPES_STRUCTS['INTERNALLOCATION'], 'INTERNALLOCATION', 'ASSIGNED_PATIENT_LOCATION', 'HL70079', -1),
    'PV1_4': ('leaf', None, 'ID', 'ADMISSION_TYPE', 'HL70007', -1),
    'PV1_5': ('leaf', None, 'ST', 'PREADMIT_NUMBER', None, -1),
    'PV1_6': ('sequence', DATATYPES_STRUCTS['INTERNALLOCATION'], 'INTERNALLOCATION', 'PRIOR_PATIENT_LOCATION', None, -1),
    'PV1_7': ('sequence', DATATYPES_STRUCTS['PHYSICIAN'], 'PHYSICIAN', 'ATTENDING_DOCTOR', 'HL70010', -1),
    'PV1_8': ('sequence', DATATYPES_STRUCTS['PHYSICIAN'], 'PHYSICIAN', 'REFERRING_DOCTOR', 'HL70010', -1),
    'PV1_9': ('sequence', DATATYPES_STRUCTS['PHYSICIAN'], 'PHYSICIAN', 'CONSULTING_DOCTOR', 'HL70010', -1),
    'PV1_10': ('leaf', None, 'ID', 'HOSPITAL_SERVICE', 'HL70069', -1),
    'PV1_11': ('sequence', DATATYPES_STRUCTS['INTERNALLOCATION'], 'INTERNALLOCATION', 'TEMPORARY_LOCATION', 'HL70079', -1),
    ...
    'PV1_17': ('sequence', DATATYPES_STRUCTS['PHYSICIAN'], 'PHYSICIAN', 'ADMITTING_DOCTOR', 'HL70010', -1),
    'PV1_18': ('leaf', None, 'ID', 'PATIENT_TYPE', 'HL70018', -1),
    'PV1_19': ('sequence', DATATYPES_STRUCTS['PATID'], 'PATID', 'VISIT_NUMBER', None, -1),
    'PV1_20': ('sequence', DATATYPES_STRUCTS['FINANCE'], 'FINANCE', 'FINANCIAL_CLASS', 'HL70064', -1),
    ...
    'PV1_42': ('sequence', DATATYPES_STRUCTS['INTERNALLOCATION'], 'INTERNALLOCATION', 'PENDING_LOCATION', None, -1),
    'PV1_43': ('sequence', DATATYPES_STRUCTS['INTERNALLOCATION'], 'INTERNALLOCATION', 'PRIOR_TEMPORARY_LOCATION', None, -1),
    ...
    'PV1_50': ('sequence', DATATYPES_STRUCTS['PATID_0192'], 'PATID_0192', 'ALTERNATE_VISIT_ID', None, -1),
    'PV2_1': ('sequence', DATATYPES_STRUCTS['INTERNALLOCATION'], 'INTERNALLOCATION', 'PRIOR_PENDING_LOCATION', None, -1),
    ...
    'QRD_11': ('sequence', DATATYPES_STRUCTS['VR'], 'VR', 'WHAT_DATA_CODE_VALUE_QUALIFIER', None, -1),
    ...
    'RXA_10': ('sequence', DATATYPES_STRUCTS['PERSON'], 'PERSON', 'ADMINISTERING_PROVIDER', None, -1),
    'RXA_11': ('sequence', DATATYPES_STRUCTS['LA1'], 'LA1', 'ADMINISTERED_AT_LOCATION', None, -1),
    ...
    'RXD_10': ('sequence', DATATYPES_STRUCTS['PERSON'], 'PERSON', 'DISPENSING_PROVIDER', None, -1),
    'RXD_11': ('leaf', None, 'ID', 'SUBSTITUTION_STATUS', 'HL70167', -1),
    'RXD_12': ('sequence', DATATYPES_STRUCTS['QUANTITY'], 'QUANTITY', 'TOTAL_DAILY_DOSE', None, -1),
    'RXD_13': ('sequence', DATATYPES_STRUCTS['LA1'], 'LA1', 'DELIVER_TO_LOCATION', None, -1),
    ...
    'RXE_13': ('sequence', DATATYPES_STRUCTS['PERSON'], 'PERSON', 'ORDERING_PROVIDER_S_DEA_NUMBER', None, -1),
    'RXE_14': ('sequence', DATATYPES_STRUCTS['PERSON'], 'PERSON', 'PHARMACIST_VERIFIER_ID', None, -1),
    ...
    'RXE_19': ('sequence', DATATYPES_STRUCTS['QUANTITY'], 'QUANTITY', 'TOTAL_DAILY_DOSE', None, -1),
    ...
    'RXG_11': ('sequence', DATATYPES_STRUCTS['LA1'], 'LA1', 'DELIVER_TO_LOCATION', None, -1),
    ...
    'RXO_14': ('sequence', DATATYPES_STRUCTS['PERSON'], 'PERSON', 'ORDERING_PROVIDER_S_DEA_NUMBER', None, -1),
    'RXO_15': ('sequence', DATATYPES_STRUCTS['PERSON'], 'PERSON', 'PHARMACIST_VERIFIER_ID', None, -1),
    ...
    'STF_12': ('sequence', DATATYPES_STRUCTS['DIN'], 'DIN', 'ACTIVATION_DATE', None, -1),
    'STF_13': ('sequence', DATATYPES_STRUCTS['DIN'], 'DIN', 'INACTIVATION_DATE', None, -1),
    ...
    'UB1_10': ('sequence', DATATYPES_STRUCTS['UVC'], 'UVC', 'VALUE_AMOUNT_AND_CODE_46_49', 'HL70153', -1),
    ...
    'UB2_6': ('sequence', DATATYPES_STRUCTS['UVC'], 'UVC', 'VALUE_AMOUNT_AND_CODE_39_41', None, -1),
    'UB2_7': ('sequence', DATATYPES_STRUCTS['OCD'], 'OCD', 'OCCURRENCE_CODE_AND_DATE_32_35', None, -1),
